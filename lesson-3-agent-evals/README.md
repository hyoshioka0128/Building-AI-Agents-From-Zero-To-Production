...
- A step-by-step walkthrough of the evaluation pipeline in [`agent-evals.py`](./agent-evals.py)
...
[`agent-evals.py`](./agent-evals.py) implements a six-step pipeline. Here is what each step does
and why.
