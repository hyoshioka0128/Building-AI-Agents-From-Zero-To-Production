...
> Este repositório inclui traduções em mais de 50 idiomas, o que aumenta significativamente o tamanho do download. Para clonar sem as traduções, utilize o sparse checkout:
> ```bash
...
Cada lição constrói sobre a anterior, por isso recomendamos começar desde o início e avançar até ao final.
...
### Conheça Outros Aprendentes, Tire as Suas Dúvidas
...
Por favor, assegure-se que tem acesso a estes serviços antes de começar.
...
| **Lição**           | **Descrição**                                                                                   |
|---------------------|-------------------------------------------------------------------------------------------------|
| [Design do Agente](./lesson-1-agent-design/README.md)          | Uma introdução ao nosso Caso de Uso "Integração de Desenvolvedor" do Agente e como desenhar agentes eficazes  |
...
| [Avaliações do Agente](./lesson-3-agent-evals/README.md)       | Usando Microsoft Foundry, descubra quão bem os nossos Agentes de IA estão a desempenhar e como os melhorar.     |
...
Acordo de Licença de Contribuinte (CLA) declarando que tem o direito de, e de facto concede,
...
um CLA e adornará o PR adequadamente (ex., verificação de estado, comentário). Simplesmente siga as instruções
fornecidas pelo bot. Só precisará fazer isto uma vez em todos os repositórios que usem o nosso CLA.
...
Este projeto pode conter marcas registadas ou logótipos de projetos, produtos ou serviços. O uso autorizado das marcas ou logótipos da Microsoft
...
Se ficar bloqueado ou tiver dúvidas sobre a criação de apps de IA, junte-se a:
