...
![Construir Agentes de IA do Zero até à Produção](../../translated_images/pt-PT/repo-thumbnail.083b24afed61b6dd.webp)
...
## Um curso que lhe ensina os fundamentos do Ciclo de Vida de Desenvolvimento de Agentes de IA
...
[![Problemas GitHub](https://img.shields.io/github/issues/microsoft/Building-AI-Agents-From-Zero-To-Production.svg)](https://GitHub.com/microsoft/Building-AI-Agents-From-Zero-To-Production/issues/?WT.mc_id=academic-105485-koreyst)
[![Pedidos de Pull GitHub](https://img.shields.io/github/issues-pr/microsoft/Building-AI-Agents-From-Zero-To-Production.svg)](https://GitHub.com/microsoft/Building-AI-Agents-From-Zero-To-Production/pulls/?WT.mc_id=academic-105485-koreyst)
...
Este curso tem lições que cobrem os fundamentos de construir e implementar Agentes de IA.

Cada lição se baseia na anterior, por isso recomendamos começar desde o início e avançar até ao fim.

Se quiser explorar mais sobre tópicos relacionados com Agentes de IA, pode consultar o [Curso para Iniciantes em Agentes de IA](https://aka.ms/ai-agents-beginners).

### Conheça Outros Alunos, Tire as Suas Dúvidas

Se ficar bloqueado ou tiver dúvidas sobre como construir Agentes de IA, junte-se ao nosso canal dedicado no Discord em [Microsoft Foundry Discord](https://discord.gg/Kuaw3ktsu6).
...
Este curso usa atualmente o seguinte:
...
Por favor, garanta que tem acesso a estes serviços antes de começar.

Mais opções relativas à hospedagem de modelos e serviços virão em breve.

## 🗃️ Lições

| **Lição**          | **Descrição**                                                                                     |
|--------------------|-------------------------------------------------------------------------------------------------|
| [Design de Agentes](./lesson-1-agent-design/README.md)       | Uma introdução ao Caso de Uso "Developer Onboarding" e como desenhar agentes eficazes            |
| [Desenvolvimento de Agentes](./lesson-2-agent-development/README.md)  | Usando o Microsoft Agent Framework (MAF), crie 3 agentes para ajudar novos desenvolvedores no onboarding. |
| [Avaliações de Agentes](./lesson-3-agent-evals/README.md)  | Usando Microsoft Foundry, descubra o desempenho dos nossos Agentes de IA e como melhorá-los.    |
...
Acordo de Licença de Contribuinte (CLA) declarando que tem o direito de, e de facto, concede-nos
os direitos para usar a sua contribuição. Para mais detalhes, visite <https://cla.opensource.microsoft.com>.

Quando submeter um pedido de pull, um bot CLA irá automaticamente determinar se precisa de fornecer
um CLA e decorar o PR apropriadamente (ex.: verificação de estado, comentário). Simplesmente siga as instruções
fornecidas pelo bot. Só precisará fazer isto uma vez em todos os repositórios que utilizam o nosso CLA.
...
[Directrizes de Marcas & Marca da Microsoft](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general).
...
Se ficar bloqueado ou tiver quaisquer perguntas sobre a criação de aplicações de IA, junte-se a:
