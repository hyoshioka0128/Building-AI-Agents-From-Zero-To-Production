...
- Contacte [opencode@microsoft.com](mailto:opencode@microsoft.com) para perguntas ou preocupações
- Os funcionários podem contactar em [aka.ms/opensource/moderation-support](https://aka.ms/opensource/moderation-support)
