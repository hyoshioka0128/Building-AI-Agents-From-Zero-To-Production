# Budowanie Agentów AI od Zera do Produkcji

![Building AI Agents from Zero to Production](../../translated_images/pl/repo-thumbnail.083b24afed61b6dd.webp)
...
> ```
> To daje wszystko, czego potrzebujesz, aby ukończyć kurs z dużo szybszym pobraniem.
...
Jeśli chcesz dowiedzieć się więcej o tematach związanych z Agentami AI, możesz sprawdzić [Kurs Agentów AI dla Początkujących](https://aka.ms/ai-agents-beginners).

### Poznaj Innych Uczących Się, Uzyskaj Odpowiedzi na Pytania

Jeśli utkniesz lub masz pytania dotyczące budowania Agentów AI, dołącz do naszego dedykowanego kanału Discord w [Microsoft Foundry Discord](https://discord.gg/Kuaw3ktsu6).

### Co Jest Potrzebne

Każda lekcja ma własny przykład kodu, który możesz uruchomić lokalnie. Możesz [sforkować to repozytorium](https://github.com/microsoft/Building-AI-Agents-From-Zero-To-Production/fork), aby stworzyć własną kopię.

Aktualnie kurs korzysta z:
...
Upewnij się, że masz dostęp do tych usług przed rozpoczęciem.

Więcej opcji dotyczących hostingu modeli i usług wkrótce.

## 🗃️ Lekcje

| **Lekcja**         | **Opis**                                                                                  |
|--------------------|-------------------------------------------------------------------------------------------|
| [Projektowanie Agenta](./lesson-1-agent-design/README.md)       | Wprowadzenie do naszego przypadku użycia "Onboarding programistów" i jak projektować efektywnych agentów  |
| [Rozwój Agenta](./lesson-2-agent-development/README.md)  | Korzystając z Microsoft Agent Framework (MAF), stwórz 3 agentów pomagających nowym programistom w onboardingu.       |
| [Ewaluacje Agenta](./lesson-3-agent-evals/README.md)  | Korzystając z Microsoft Foundry, dowiedz się, jak dobrze działają nasi Agenci AI i jak je poprawić. |
...
Nasz zespół przygotowuje też inne kursy! Sprawdź:
...
### Seria Copilot
[![Copilot dla programowania zespołowego AI](https://img.shields.io/badge/Copilot%20for%20AI%20Paired%20Programming-FACC15?style=for-the-badge&labelColor=E5E7EB&color=FACC15)](https://aka.ms/GitHubCopilotAI?WT.mc_id=academic-105485-koreyst)
...
CLA i odpowiednio oznaczy PR (np. sprawdzenie statusu, komentarz). Wystarczy postępować zgodnie z instrukcjami
podanymi przez bota. Będziesz musiał to zrobić tylko raz we wszystkich repozytoriach korzystających z naszej CLA.

Projekt przyjął [Kodeks Postępowania Microsoft Open Source](https://opensource.microsoft.com/codeofconduct/).
Więcej informacji znajduje się w [FAQ Kodeksu Postępowania](https://opensource.microsoft.com/codeofconduct/faq/) lub
...
Użycie znaków towarowych lub logotypów Microsoft w zmodyfikowanych wersjach tego projektu nie może powodować zamieszania ani sugerować sponsoringu Microsoft.
Każde użycie znaków towarowych lub logotypów osób trzecich podlega polityce tych osób trzecich.
