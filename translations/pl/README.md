...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-24T23:20:42+00:00",
...
![Budowanie agentów AI od zera do produkcji](../../translated_images/pl/repo-thumbnail.083b24afed61b6dd27a7fc53798bebe9edf688a41031163a1fca9f61c64d63ec.png)
...
[![Zgłoszenia GitHub](https://img.shields.io/github/issues/microsoft/Building-AI-Agents-From-Zero-To-Production.svg)](https://GitHub.com/microsoft/Building-AI-Agents-From-Zero-To-Production/issues/?WT.mc_id=academic-105485-koreyst)
...
Każda lekcja opiera się na poprzedniej, dlatego zalecamy rozpoczęcie od początku i przechodzenie kolejno aż do końca.

Jeśli chcesz zgłębić tematy związane z agentami AI, możesz sprawdzić kurs [Kurs Agenci AI dla początkujących](https://aka.ms/ai-agents-beginners).

### Poznaj innych uczestników, uzyskaj odpowiedzi na swoje pytania

Jeśli utkniesz lub będziesz miał pytania dotyczące tworzenia agentów AI, dołącz do naszego dedykowanego kanału na Discordzie w [Discord Microsoft Foundry](https://discord.gg/Kuaw3ktsu6).

### Czego potrzebujesz

Każda lekcja ma własny przykład kodu, który możesz uruchomić lokalnie. Możesz [stwórz fork tego repozytorium](https://github.com/microsoft/Building-AI-Agents-From-Zero-To-Production/fork), aby utworzyć własną kopię.

Kurs aktualnie wykorzystuje następujące elementy:
...
| **Lekcja**         | **Opis**                                                                                  |
|--------------------|------------------------------------------------------------------------------------------|
| [Projekt agenta](./lesson-1-agent-design/README.md)       | An introduction to our "Developer Onboarding" Agent Use Case and how to design effective agents  |
| [Rozwój agenta](./lesson-2-agent-development/README.md)  | Korzystając z Microsoft Agent Framework (MAF), stwórz 3 agentów pomagających nowym deweloperom się wdrożyć.       |
| [Ewaluacja agentów](./lesson-3-agent-evals/README.md)  | Korzystając z Microsoft Foundry, dowiedz się, jak dobrze działają nasi agenci AI i jak je usprawnić. |
...
Ten projekt zaprasza do nadsyłania wkładu i sugestii. Większość wkładów wymaga zgody na Umowę licencyjną kontrybutora (Contributor License Agreement, CLA), w której oświadczasz, że masz prawo i faktycznie udzielasz nam praw do wykorzystania Twojego wkładu. Szczegóły znajdziesz na <https://cla.opensource.microsoft.com>.

Gdy zgłosisz pull request, bot CLA automatycznie określi, czy musisz dostarczyć CLA i oznaczy PR odpowiednio (np. sprawdzenie statusu, komentarz). Po prostu wykonaj instrukcje podane przez bota. Będziesz musiał zrobić to tylko raz we wszystkich repozytoriach korzystających z naszej CLA.

Ten projekt przyjął [Microsoft Open Source Code of Conduct](https://opensource.microsoft.com/codeofconduct/). Po więcej informacji zobacz [Code of Conduct FAQ](https://opensource.microsoft.com/codeofconduct/faq/) lub skontaktuj się z [opencode@microsoft.com](mailto:opencode@microsoft.com) w sprawie dodatkowych pytań lub uwag.
...
Każde użycie znaków towarowych lub logotypów stron trzecich podlega zasadom tych stron trzecich.
...
**Zastrzeżenie**:
Ten dokument został przetłumaczony przy użyciu usługi tłumaczeń AI [Co-op Translator](https://github.com/Azure/co-op-translator). Dokładamy starań, aby zapewnić dokładność, jednak prosimy pamiętać, że tłumaczenia automatyczne mogą zawierać błędy lub nieścisłości. Oryginalny dokument w języku źródłowym powinien być traktowany jako źródło wiążące. W przypadku informacji o krytycznym znaczeniu zalecane jest skorzystanie z profesjonalnego tłumaczenia wykonanego przez człowieka. Nie ponosimy odpowiedzialności za jakiekolwiek nieporozumienia lub błędne interpretacje wynikające z korzystania z tego tłumaczenia.
