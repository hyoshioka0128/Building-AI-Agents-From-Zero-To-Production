# Tworzenie agentów AI od podstaw do produkcji

![Tworzenie agentów AI od podstaw do produkcji](../../translated_images/pl/repo-thumbnail.083b24afed61b6dd.webp)
...
> ```
> Dzięki temu otrzymasz wszystko, czego potrzebujesz, aby ukończyć kurs, przy dużo szybszym pobieraniu.
<!-- CO-OP TRANSLATOR LANGUAGES TABLE END -->

## Kurs uczący podstaw cyklu życia rozwoju Agenta AI

[![Licencja GitHub](https://img.shields.io/github/license/microsoft/Building-AI-Agents-From-Zero-To-Production.svg)](https://github.com/microsoft/Building-AI-Agents-From-Zero-To-Production/blob/master/LICENSE?WT.mc_id=academic-105485-koreyst)
[![Współtwórcy GitHub](https://img.shields.io/github/contributors/microsoft/Building-AI-Agents-From-Zero-To-Production.svg)](https://GitHub.com/microsoft/Building-AI-Agents-From-Zero-To-Production/graphs/contributors/?WT.mc_id=academic-105485-koreyst)
[![Problemy GitHub](https://img.shields.io/github/issues/microsoft/Building-AI-Agents-From-Zero-To-Production.svg)](https://GitHub.com/microsoft/Building-AI-Agents-From-Zero-To-Production/issues/?WT.mc_id=academic-105485-koreyst)
...
[![PRs mile widziane](https://img.shields.io/badge/PRs-welcome-brightgreen.svg?style=flat-square)](http://makeapullrequest.com?WT.mc_id=academic-105485-koreyst)

[![Microsoft Foundry Discord](https://dcbadge.limes.pink/api/server/nTYy5BXMWG)](https://discord.gg/Kuaw3ktsu6)

## 🌱 Rozpoczęcie

Ten kurs zawiera lekcje obejmujące podstawy budowania i wdrażania agentów AI.

Każda lekcja opiera się na poprzedniej, dlatego zalecamy rozpoczęcie od początku i przejście do końca.

Jeśli chcesz zgłębić więcej tematów dotyczących agentów AI, możesz sprawdzić [Kurs dla początkujących dotyczący agentów AI](https://aka.ms/ai-agents-beginners).

### Poznaj innych uczących się, uzyskaj odpowiedzi na swoje pytania

Jeżeli utkniesz lub masz pytania dotyczące tworzenia agentów AI, dołącz do naszego dedykowanego kanału Discord na [Microsoft Foundry Discord](https://discord.gg/Kuaw3ktsu6).

### Czego potrzebujesz

Każda lekcja zawiera własny przykład kodu, który możesz uruchomić lokalnie. Możesz [sforkować to repozytorium](https://github.com/microsoft/Building-AI-Agents-From-Zero-To-Production/fork), aby utworzyć własną kopię.

Kurs obecnie korzysta z następujących narzędzi:
...
Wkrótce pojawią się dodatkowe opcje hostowania modeli i usług.

## 🗃️ Lekcje

| **Lekcja**         | **Opis**                                                                                      |
|--------------------|-----------------------------------------------------------------------------------------------|
| [Projektowanie Agenta](./lesson-1-agent-design/README.md)       | Wprowadzenie do przypadku użycia Agenta "Onboarding dla programistów" i jak zaprojektować efektywne agentów  |
| [Rozwój Agenta](./lesson-2-agent-development/README.md)  | Korzystając z Microsoft Agent Framework (MAF), stwórz 3 agentów, którzy pomogą nowym programistom w onboardingu.       |
| [Oceny Agenta](./lesson-3-agent-evals/README.md)  | Korzystając z Microsoft Foundry, dowiedz się, jak dobrze działają nasze Agenty AI i jak je ulepszyć. |
| [Wdrożenie Agenta](./lesson-4-agent-deployment/README.md)   | Korzystając z Hosted Agents i OpenAI Chatkit, zobacz jak wdrożyć Agenta AI do produkcji.       |
...
Umowę Licencyjną Współtwórcy (CLA), oświadczającą, że masz prawo i faktycznie przyznajesz nam
prawo do korzystania z twojego wkładu. Szczegóły znajdziesz na <https://cla.opensource.microsoft.com>.

Gdy zgłosisz pull request, bot CLA automatycznie stwierdzi, czy musisz dostarczyć
...
[Zasady dotyczące znaków towarowych i marek Microsoft](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general).
