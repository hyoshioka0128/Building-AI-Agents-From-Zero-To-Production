# Byg AI-Agenter fra Bunden til Produktion

![Byg AI-Agenter fra Bunden til Produktion](../../translated_images/da/repo-thumbnail.083b24afed61b6dd.webp)
...
Dette kursus indeholder lektioner, der dækker grundlæggende principper for at bygge og implementere AI-agenter.
...
Hvis du ønsker at udforske mere om AI Agent emner, kan du tjekke [AI Agents For Beginners Kurset](https://aka.ms/ai-agents-beginners).
...
Hver lektion har sin egen kodeeksempel, som du kan køre lokalt. Du kan [forke dette repo](https://github.com/microsoft/Building-AI-Agents-From-Zero-To-Production/fork) for at skabe din egen kopi.
...
Sørg for, at du har adgang til disse services, før du går i gang.
...
| [Agent Evalueringer](./lesson-3-agent-evals/README.md)  | Brug Microsoft Foundry til at finde ud af, hvor godt vores AI Agenter præsterer, og hvordan man forbedrer dem. |
| [Agent Implementering](./lesson-4-agent-deployment/README.md)   | Brug Hosted Agents og OpenAI Chatkit til at se, hvordan man implementerer en AI Agent i produktion.       |
...
Dette projekt byder bidrag og forslag velkomne. De fleste bidrag kræver, at du accepterer en
Bidragyder Licensaftale (CLA), hvor du erklærer, at du har ret til og faktisk gør os i stand til
at bruge dit bidrag. For detaljer, se <https://cla.opensource.microsoft.com>.

Når du indsender en pull-anmodning, vil en CLA-bot automatisk afgøre, om du skal give
en CLA og dekorere PR passende (f.eks. statuskontrol, kommentar). Følg blot instruktionerne
