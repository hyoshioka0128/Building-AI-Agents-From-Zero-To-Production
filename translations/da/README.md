...
## Et kursus, der lærer dig grundprincipperne i AI-agentens udviklingslivscyklus
...
Dette kursus har lektioner, der dækker grundprincipperne i at bygge og implementere AI-agenter.
...
Hvis du ønsker at udforske flere emner om AI-agenter, kan du tjekke [AI Agents For Beginners-kurset](https://aka.ms/ai-agents-beginners).
...
Hver lektion har sit eget kodeeksempel, som du kan køre lokalt. Du kan [forke dette repository](https://github.com/microsoft/Building-AI-Agents-From-Zero-To-Production/fork) for at lave din egen kopi.
...
Flere muligheder omkring modelhostning og tjenester kommer snart.
...
| [Agent Udvikling](./lesson-2-agent-development/README.md)  | Brug Microsoft Agent Framework (MAF) til at skabe 3 agenter, der hjælper nye udviklere med onboarding.       |
| [Agent Evalueringer](./lesson-3-agent-evals/README.md)  | Ved hjælp af Microsoft Foundry, find ud af hvor godt vores AI-agenter præsterer og hvordan de kan forbedres. |
| [Agent Implementering](./lesson-4-agent-deployment/README.md)   | Brug Hosted Agents og OpenAI Chatkit til at se, hvordan en AI-agent implementeres i produktion.       |
...
Bidragsyders Licensaftale (CLA), der erklærer, at du har ret til, og faktisk giver os
rettighederne til at bruge dit bidrag. For detaljer, besøg <https://cla.opensource.microsoft.com>.

Når du sender en pull-anmodning, vil en CLA-bot automatisk afgøre, om du skal indsende
en CLA og markere PR passende (fx statuscheck, kommentar). Følg blot instruktionerne
...
kontakt [opencode@microsoft.com](mailto:opencode@microsoft.com) med eventuelle spørgsmål eller kommentarer.
...
Brug af Microsoft-varemærker eller logoer i ændrede versioner af dette projekt må ikke skabe forvirring eller give indtryk af Microsoft-sponsorering.
