...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-24T23:30:23+00:00",
...
![Byg AI-agenter fra nul til produktion](../../translated_images/da/repo-thumbnail.083b24afed61b6dd27a7fc53798bebe9edf688a41031163a1fca9f61c64d63ec.png)
...
## Et kursus, der lærer dig grundprincipperne i AI-agenters udviklingslivscyklus
...
Dette kursus indeholder lektioner, der dækker grundlæggende principper for at bygge og udrulle AI-agenter.
...
Hvis du vil udforske mere om AI-agentemner, kan du tjekke [AI-agenter for begyndere](https://aka.ms/ai-agents-beginners).

### Mød andre studerende, få svar på dine spørgsmål

Hvis du sidder fast eller har spørgsmål om at bygge AI-agenter, kan du deltage i vores dedikerede Discord-kanal i the [Microsoft Foundry Discord](https://discord.gg/Kuaw3ktsu6).
...
| **Lektion**         | **Beskrivelse**                                                                                  |
|--------------------|--------------------------------------------------------------------------------------------------|
| [Agent Design](./lesson-1-agent-design/README.md)       | En introduktion til vores "Developer Onboarding" agentbrugssag og hvordan man designer effektive agenter  |
| [Agent Development](./lesson-2-agent-development/README.md)  | Ved hjælp af Microsoft Agent Framework (MAF) opretter du 3 agenter til at hjælpe nye udviklere i gang.       |
| [Agent Evaluations](./lesson-3-agent-evals/README.md)  | Ved hjælp af Microsoft Foundry kan du finde ud af, hvor godt vores AI-agenter præsterer, og hvordan man forbedrer dem. |
| [Agent Deployment](./lesson-4-agent-deployment/README.md)   | Ved hjælp af Hosted Agents og OpenAI Chatkit kan du se, hvordan du udruller en AI-agent i produktion.       |
...
Dette projekt byder bidrag og forslag velkommen. De fleste bidrag kræver, at du accepterer en Contributor License Agreement (CLA), som erklærer, at du har ret til, og rent faktisk giver os rettighederne til at bruge dit bidrag. For detaljer, besøg <https://cla.opensource.microsoft.com>.
...
Dette projekt har vedtaget [Microsofts adfærdskodeks for open source](https://opensource.microsoft.com/codeofconduct/).
For mere information se [FAQ om adfærdskodeks](https://opensource.microsoft.com/codeofconduct/faq/) eller
kontakt [opencode@microsoft.com](mailto:opencode@microsoft.com) for yderligere spørgsmål eller kommentarer.
