...
## Ein Kurs, der Ihnen die Grundlagen des Entwicklungszyklus für KI-Agenten vermittelt
...
Jede Lektion baut auf der vorherigen auf, daher empfehlen wir, von vorne zu beginnen und sich bis zum Ende durchzuarbeiten.

Wenn Sie mehr zu Themen rund um KI-Agenten erfahren möchten, schauen Sie sich den [KI-Agenten für Anfänger Kurs](https://aka.ms/ai-agents-beginners) an.

### Lernen Sie andere Lernende kennen und erhalten Sie Antworten auf Ihre Fragen
...
Weitere Optionen für Modell-Hosting und Services folgen in Kürze.

## 🗃️ Lektionen

| **Lektion**         | **Beschreibung**                                                                                            |
|--------------------|--------------------------------------------------------------------------------------------------------------|
| [Agentendesign](./lesson-1-agent-design/README.md)       | Eine Einführung in unseren Agenten-Anwendungsfall "Developer Onboarding" und wie man effektive Agenten gestaltet |
| [Agentenentwicklung](./lesson-2-agent-development/README.md)  | Erstellung von 3 Agenten mit dem Microsoft Agent Framework (MAF), um neuen Entwicklern beim Onboarding zu helfen. |
| [Agentenbewertungen](./lesson-3-agent-evals/README.md)  | Mithilfe von Microsoft Foundry erfahren, wie gut unsere KI-Agenten arbeiten und wie man sie verbessern kann.    |
| [Agentenbereitstellung](./lesson-4-agent-deployment/README.md)   | Mit gehosteten Agenten und OpenAI Chatkit erfahren, wie man einen KI-Agenten produktiv einsetzt.                |
...
Contributor License Agreement (CLA) zustimmen, die besagt, dass Sie das Recht haben und tatsächlich
die Rechte gewähren, Ihre Beiträge zu verwenden. Für Details besuchen Sie <https://cla.opensource.microsoft.com>.

Wenn Sie eine Pull-Anfrage einreichen, wird ein CLA-Bot automatisch feststellen, ob Sie eine
...
des Bots. Sie müssen dies nur einmal über alle Repositories erledigen, die unsere CLA nutzen.

Dieses Projekt hat den [Microsoft Open Source Code of Conduct](https://opensource.microsoft.com/codeofconduct/) übernommen.
Weitere Informationen finden Sie in den [FAQ zum Verhaltenskodex](https://opensource.microsoft.com/codeofconduct/faq/) oder kontaktieren Sie [opencode@microsoft.com](mailto:opencode@microsoft.com) mit Fragen oder Anmerkungen.

## Marken

Dieses Projekt kann Marken oder Logos für Projekte, Produkte oder Dienstleistungen enthalten. Die autorisierte Nutzung der Microsoft
Marken oder Logos unterliegt den
[Microsoft Marken- & Branding-Richtlinien](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general).
...
Für Produktfeedback oder bei Fehlern während der Entwicklung besuchen Sie:
