...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-24T22:38:29+00:00",
  "source_file": "README.md",
  "language_code": "de"
}
-->
# AI-Agenten von Null bis zur Produktion erstellen

![AI-Agenten von Null bis zur Produktion erstellen](../../translated_images/de/repo-thumbnail.083b24afed61b6dd27a7fc53798bebe9edf688a41031163a1fca9f61c64d63ec.png)

### 🌐 Mehrsprachige Unterstützung

#### Unterstützt über GitHub Action (Automatisch & stets aktuell)
...
## Ein Kurs, der Ihnen die Grundlagen des gesamten Entwicklungszyklus von KI-Agenten vermittelt
...
[![GitHub-Pull-Anfragen](https://img.shields.io/github/issues-pr/microsoft/Building-AI-Agents-From-Zero-To-Production.svg)](https://GitHub.com/microsoft/Building-AI-Agents-From-Zero-To-Production/pulls/?WT.mc_id=academic-105485-koreyst)
...
Dieser Kurs enthält Lektionen, die die Grundlagen des Erstellens und Bereitstellens von KI-Agenten behandeln.

Jede Lektion baut auf der vorherigen auf, daher empfehlen wir, am Anfang zu beginnen und bis zum Ende zu arbeiten.

Wenn Sie mehr über Themen zu KI-Agenten erfahren möchten, können Sie den Kurs [AI Agents für Einsteiger](https://aka.ms/ai-agents-beginners) anschauen.

### Andere Lernende treffen, Antworten auf Ihre Fragen bekommen

Wenn Sie nicht weiterkommen oder Fragen zum Erstellen von KI-Agenten haben, treten Sie unserem dedizierten Discord-Kanal im [Microsoft Foundry Discord](https://discord.gg/Kuaw3ktsu6) bei.
...
Dieser Kurs verwendet derzeit die folgenden:
...
Bitte stellen Sie sicher, dass Sie vor dem Start Zugriff auf diese Dienste haben.
...
|--------------------|--------------------------------------------------------------------------------------------------|
| [Agenten-Design](./lesson-1-agent-design/README.md)       | Eine Einführung in unseren "Developer Onboarding" Agent Use Case und wie man effektive Agenten entwirft  |
| [Agentenentwicklung](./lesson-2-agent-development/README.md)  | Verwenden Sie das Microsoft Agent Framework (MAF), um 3 Agenten zu erstellen, die neuen Entwicklern beim Onboarding helfen.       |
| [Agenten-Evaluationen](./lesson-3-agent-evals/README.md)  | Erfahren Sie mit Microsoft Foundry, wie gut unsere KI-Agenten abschneiden und wie Sie sie verbessern können. |
| [Agentenbereitstellung](./lesson-4-agent-deployment/README.md)   | Verwenden Sie die Hosted Agents und OpenAI Chatkit, um zu sehen, wie man einen KI-Agenten in Produktion einsetzt.       |
...
### Generative-AI-Serie
[![Generative AI für Einsteiger](https://img.shields.io/badge/Generative%20AI%20for%20Beginners-8B5CF6?style=for-the-badge&labelColor=E5E7EB&color=8B5CF6)](https://github.com/microsoft/generative-ai-for-beginners?WT.mc_id=academic-105485-koreyst)
...
Dieses Projekt freut sich über Beiträge und Vorschläge. Die meisten Beiträge erfordern, dass Sie einer Lizenzvereinbarung für Beitragende (Contributor License Agreement, CLA) zustimmen, in der erklärt wird, dass Sie das Recht haben und tatsächlich die Rechte einräumen, die uns die Nutzung Ihres Beitrags ermöglichen. Weitere Informationen finden Sie unter <https://cla.opensource.microsoft.com>.

Wenn Sie eine Pull-Anfrage (Pull Request) einreichen, ermittelt ein CLA-Bot automatisch, ob Sie eine CLA vorlegen müssen, und kennzeichnet die PR entsprechend (z. B. Statusüberprüfung, Kommentar). Befolgen Sie einfach die Anweisungen des Bots. Dies müssen Sie nur einmal für alle Repositories tun, die unsere CLA verwenden.

Dieses Projekt hat den [Microsoft Open Source Verhaltenskodex](https://opensource.microsoft.com/codeofconduct/) übernommen.
Weitere Informationen finden Sie in den [FAQ zum Verhaltenskodex](https://opensource.microsoft.com/codeofconduct/faq/) oder kontaktieren Sie [opencode@microsoft.com](mailto:opencode@microsoft.com) bei weiteren Fragen oder Kommentaren.

## Marken

Dieses Projekt kann Marken oder Logos für Projekte, Produkte oder Dienste enthalten. Die autorisierte Verwendung von Microsoft-Marken oder -Logos unterliegt und muss den [Microsofts Richtlinien zu Marken und Branding](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general) folgen.
Die Verwendung von Microsoft-Marken oder -Logos in bearbeiteten Versionen dieses Projekts darf nicht zu Verwechslungen führen oder eine Microsoft-Unterstützung suggerieren.
Jede Verwendung von Marken oder Logos Dritter unterliegt den Richtlinien dieser Drittparteien.
