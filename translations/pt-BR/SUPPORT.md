...
**PROPRIETÁRIO DO REPO**: Você quer suporte de Atendimento e Suporte ao Cliente (CSS) para este produto/projeto?
...
Este projeto usa o GitHub Issues para rastrear bugs e solicitações de recursos. Por favor, pesquise os problemas existentes antes de registrar novos para evitar duplicatas. Para novos problemas, registre seu bug ou solicitação de recurso como uma nova Issue.

Para ajuda e dúvidas sobre o uso deste projeto, por favor **MANTENEDOR DO REPOSITÓRIO: INSIRA AQUI INSTRUÇÕES SOBRE COMO ENTRAR EM CONTATO COM OS PROPRIETÁRIOS DO REPOSITÓRIO OU COMUNIDADE PARA AJUDA. PODERIA SER UMA TAG DO STACK OVERFLOW OU OUTRO CANAL. ONDE VOCÊ AJUDARÁ AS PESSOAS?**.
