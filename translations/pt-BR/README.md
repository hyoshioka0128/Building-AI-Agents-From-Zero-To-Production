...
Este curso possui lições que cobrem os fundamentos para construir e implantar Agentes de IA.

Cada lição se baseia na anterior, então recomendamos começar do início e progredir até o final.
...
Se ficar preso ou tiver dúvidas sobre como construir Agentes de IA, junte-se ao nosso canal dedicado no Discord do [Microsoft Foundry Discord](https://discord.gg/Kuaw3ktsu6).
...
Atualmente este curso utiliza o seguinte:
...
| **Lição**         | **Descrição**                                                                                  |
|--------------------|--------------------------------------------------------------------------------------------------|
| [Design do Agente](./lesson-1-agent-design/README.md)       | Uma introdução ao nosso Caso de Uso "Onboarding de Desenvolvedor" para Agentes e como projetar agentes eficazes  |
| [Desenvolvimento do Agente](./lesson-2-agent-development/README.md)  | Usando o Microsoft Agent Framework (MAF), crie 3 agentes para ajudar novos desenvolvedores a começarem.       |
| [Avaliações do Agente](./lesson-3-agent-evals/README.md)  | Usando Microsoft Foundry, descubra o desempenho dos nossos Agentes de IA e como melhorá-los. |
...
Acordo de Licença de Contribuidor (CLA) declarando que você tem o direito e de fato concede a nós
os direitos para usar sua contribuição. Para mais detalhes, visite <https://cla.opensource.microsoft.com>.

Quando você submeter um pull request, um bot CLA determinará automaticamente se você precisa fornecer
um CLA e decorará o PR adequadamente (ex: verificação de status, comentário). Simplesmente siga as instruções
...
registradas ou logotipos da Microsoft está sujeito a e deve seguir
[As Diretrizes de Marcas Registradas e Marca da Microsoft](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general).
