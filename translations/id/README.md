...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-24T23:40:00+00:00",
  "source_file": "README.md",
  "language_code": "id"
}
-->
# Membangun Agen AI dari Nol sampai Produksi

![Membangun Agen AI dari Nol sampai Produksi](../../translated_images/id/repo-thumbnail.083b24afed61b6dd27a7fc53798bebe9edf688a41031163a1fca9f61c64d63ec.png)
...
Setiap pelajaran dibangun berdasarkan pelajaran sebelumnya, jadi kami sarankan memulai dari awal dan mengikutinya hingga akhir.

Jika Anda ingin menjelajahi lebih banyak topik tentang Agen AI, Anda dapat melihat [AI Agents For Beginenrs Course](https://aka.ms/ai-agents-beginners).

### Bertemu Pelajar Lain, Dapatkan Jawaban untuk Pertanyaan Anda

Jika Anda mengalami kebuntuan atau memiliki pertanyaan tentang membangun Agen AI, bergabunglah dengan Saluran Discord khusus kami di [Microsoft Foundry Discord](https://discord.gg/Kuaw3ktsu6).

### Yang Anda Butuhkan

Setiap Pelajaran memiliki contoh kode sendiri yang dapat Anda jalankan secara lokal. Anda dapat [fork this repo](https://github.com/microsoft/Building-AI-Agents-From-Zero-To-Production/fork) untuk membuat salinan Anda sendiri.
...
Lebih banyak opsi terkait hosting model dan layanan akan segera hadir. 

## 🗃️ Pelajaran

| **Pelajaran**         | **Deskripsi**                                                                                  |
|--------------------|--------------------------------------------------------------------------------------------------|
| [Desain Agen](./lesson-1-agent-design/README.md)       | Pengantar Use Case Agen "Developer Onboarding" kami dan bagaimana merancang agen yang efektif  |
| [Pengembangan Agen](./lesson-2-agent-development/README.md)  | Menggunakan Microsoft Agent Framework (MAF), buat 3 agen untuk membantu pengembang baru memulai.       |
| [Evaluasi Agen](./lesson-3-agent-evals/README.md)  | Menggunakan Microsoft Foundry, cari tahu seberapa baik kinerja Agen AI kami dan bagaimana meningkatkannya. |
...
Perjanjian Lisensi Kontributor (CLA) yang menyatakan bahwa Anda memiliki hak, dan memang benar memberikan kepada kami
hak untuk menggunakan kontribusi Anda. Untuk detail, kunjungi <https://cla.opensource.microsoft.com>.

Ketika Anda mengajukan pull request, bot CLA akan secara otomatis menentukan apakah Anda perlu menyediakan
CLA dan menandai PR dengan tepat (mis. pemeriksaan status, komentar). Cukup ikuti instruksi
...
Proyek ini mungkin berisi merek dagang atau logo untuk proyek, produk, atau layanan. Penggunaan resmi atas Microsoft
merek dagang atau logo tergantung pada dan harus mengikuti
...
[![Microsoft Foundry di Discord](https://dcbadge.limes.pink/api/server/nTYy5BXMWG)](https://discord.gg/Kuaw3ktsu6)
