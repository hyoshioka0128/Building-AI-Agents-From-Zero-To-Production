...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2026-01-16T09:20:22+00:00",
...
![Membangun Agen AI dari Nol hingga Produksi](../../../../translated_images/id/repo-thumbnail.083b24afed61b6dd.webp)
...
## Sebuah kursus yang mengajarkan Anda dasar-dasar Siklus Hidup Pengembangan Agen AI

[![Lisensi GitHub](https://img.shields.io/github/license/microsoft/Building-AI-Agents-From-Zero-To-Production.svg)](https://github.com/microsoft/Building-AI-Agents-From-Zero-To-Production/blob/master/LICENSE?WT.mc_id=academic-105485-koreyst)
[![Kontributor GitHub](https://img.shields.io/github/contributors/microsoft/Building-AI-Agents-From-Zero-To-Production.svg)](https://GitHub.com/microsoft/Building-AI-Agents-From-Zero-To-Production/graphs/contributors/?WT.mc_id=academic-105485-koreyst)
...
[![PRs Selamat Datang](https://img.shields.io/badge/PRs-welcome-brightgreen.svg?style=flat-square)](http://makeapullrequest.com?WT.mc_id=academic-105485-koreyst)
...
Setiap pelajaran dibangun berdasarkan pelajaran sebelumnya, jadi kami menyarankan memulai dari awal dan terus bekerja hingga akhir.

Jika Anda ingin menjelajahi lebih lanjut tentang topik Agen AI, Anda dapat melihat [Kursus AI Agents Untuk Pemula](https://aka.ms/ai-agents-beginners).

### Bertemu Pelajar Lain, Dapatkan Jawaban atas Pertanyaan Anda

Jika Anda mengalami kebingungan atau memiliki pertanyaan tentang membangun Agen AI, bergabunglah dengan Saluran Discord khusus kami di [Microsoft Foundry Discord](https://discord.gg/Kuaw3ktsu6).

### Apa yang Anda Butuhkan

Setiap Pelajaran memiliki contoh kode sendiri yang dapat Anda jalankan secara lokal. Anda dapat [membuat fork repositori ini](https://github.com/microsoft/Building-AI-Agents-From-Zero-To-Production/fork) untuk membuat salinan Anda sendiri.

Kursus ini saat ini menggunakan hal berikut:
...
Pastikan Anda memiliki akses ke layanan ini sebelum mulai.

Pilihan lebih lanjut mengenai hosting model dan layanan akan segera hadir.

## 🗃️ Pelajaran

| **Pelajaran**         | **Deskripsi**                                                                                 |
|-----------------------|------------------------------------------------------------------------------------------------|
| [Desain Agen](./lesson-1-agent-design/README.md)          | Pengantar Use Case Agen "Developer Onboarding" kami dan cara merancang agen yang efektif      |
...
| [Evaluasi Agen](./lesson-3-agent-evals/README.md)         | Menggunakan Microsoft Foundry, cari tahu seberapa baik kinerja Agen AI kami dan cara meningkatkannya. |
| [Deployment Agen](./lesson-4-agent-deployment/README.md)  | Menggunakan Hosted Agents dan OpenAI Chatkit, lihat cara menerapkan Agen AI ke produksi.      |
...
Ketika Anda mengirimkan pull request, bot CLA akan secara otomatis menentukan apakah Anda perlu menyediakan
CLA dan menandai PR dengan tepat (misalnya, pemeriksaan status, komentar). Ikuti saja petunjuk
yang diberikan oleh bot. Anda hanya perlu melakukan ini sekali di semua repo yang menggunakan CLA kami.

Proyek ini mengadopsi [Kode Etik Open Source Microsoft](https://opensource.microsoft.com/codeofconduct/).
...
Jika Anda terjebak atau memiliki pertanyaan tentang pembangunan aplikasi AI, bergabunglah:
