...
![Building AI Agents from Zero to Production](../../translated_images/id/repo-thumbnail.083b24afed61b6dd.webp)
...
Kursus ini memiliki pelajaran yang mencakup dasar-dasar pembangunan dan penyebaran Agen AI.

Setiap pelajaran membangun dari yang sebelumnya, jadi kami sarankan mulai dari awal dan teruskan sampai selesai.

Jika Anda ingin mengeksplor lebih lanjut tentang topik Agen AI, Anda dapat memeriksa [Kursus AI Agents Untuk Pemula](https://aka.ms/ai-agents-beginners).

### Bertemu Peserta Lain, Dapatkan Jawaban atas Pertanyaan Anda

Jika Anda mengalami kesulitan atau memiliki pertanyaan tentang membangun Agen AI, bergabunglah dengan Saluran Discord khusus kami di [Microsoft Foundry Discord](https://discord.gg/Kuaw3ktsu6).

### Apa yang Anda Butuhkan

Setiap pelajaran memiliki contoh kode yang dapat Anda jalankan secara lokal. Anda dapat [fork repo ini](https://github.com/microsoft/Building-AI-Agents-From-Zero-To-Production/fork) untuk membuat salinan Anda sendiri.

Saat ini kursus ini menggunakan hal-hal berikut:
...
Pastikan Anda memiliki akses ke layanan-layanan ini sebelum memulai.

Pilihan lain terkait hosting model dan layanan akan segera hadir.

## 🗃️ Pelajaran

| **Pelajaran**         | **Deskripsi**                                                                                  |
|--------------------|--------------------------------------------------------------------------------------------------|
| [Desain Agen](./lesson-1-agent-design/README.md)       | Pengantar ke Kasus Penggunaan Agen "Developer Onboarding" dan cara merancang agen yang efektif  |
...
| [Penerapan Agen](./lesson-4-agent-deployment/README.md)   | Menggunakan Agen yang Dihosting dan OpenAI Chatkit, lihat cara menyebarkan Agen AI ke produksi.       |
...
CLA dan menghias PR secara tepat (misalnya, pemeriksaan status, komentar). Cukup ikuti instruksi
...
Penggunaan merek dagang atau logo Microsoft dalam versi modifikasi proyek ini tidak boleh menyebabkan kebingungan atau menyiratkan sponsorship Microsoft.
