...
- Kapcsolat: [opencode@microsoft.com](mailto:opencode@microsoft.com) kérdések vagy aggályok esetén
- Az alkalmazottak elérhetik a [aka.ms/opensource/moderation-support](https://aka.ms/opensource/moderation-support) oldalt támogatásért
