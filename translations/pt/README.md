...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2026-01-16T08:46:25+00:00",
...
![Construir Agentes de IA do Zero à Produção](../../../../translated_images/pt/repo-thumbnail.083b24afed61b6dd.webp)
...
Cada lição baseia-se na anterior, por isso recomenda-se começar do início e avançar até ao fim.

Se quiser explorar mais sobre tópicos relacionados com Agentes de IA, pode consultar o [Curso Agentes de IA para Iniciantes](https://aka.ms/ai-agents-beginners).

### Conheça Outros Aprendizes, Tire as Suas Dúvidas

Se ficar preso ou tiver alguma pergunta sobre a construção de Agentes de IA, junte-se ao nosso canal dedicado no Discord em [Microsoft Foundry Discord](https://discord.gg/Kuaw3ktsu6).
...
Mais opções relativas ao alojamento de modelos e serviços em breve. 

## 🗃️ Lições

| **Lição**         | **Descrição**                                                                                  |
|--------------------|--------------------------------------------------------------------------------------------------|
| [Design de Agente](./lesson-1-agent-design/README.md)       | Uma introdução ao nosso Caso de Uso "Onboarding de Desenvolvedor" e como desenhar agentes eficazes  |
...
| [Avaliações de Agente](./lesson-3-agent-evals/README.md)  | Usando Microsoft Foundry, descubra quão bem os nossos Agentes de IA estão a desempenhar e como melhorá-los. |
| [Implementação de Agente](./lesson-4-agent-deployment/README.md)   | Usando os Agentes Hospedados e OpenAI Chatkit, veja como implementar um Agente de IA em produção.       |
...
Acordo de Licença de Contribuinte (CLA) declarando que tem o direito de, e realmente, nos concede
os direitos para usar a sua contribuição. Para mais detalhes, visite <https://cla.opensource.microsoft.com>.

Quando submeter um pull request, um bot CLA determinará automaticamente se necessita fornecer
...
ou logótipos da Microsoft está sujeito a e deve seguir
[Diretrizes de Marcas e Marca da Microsoft](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general).
O uso das marcas ou logótipos da Microsoft em versões modificadas deste projeto não pode causar confusão nem implicar patrocínio da Microsoft.
