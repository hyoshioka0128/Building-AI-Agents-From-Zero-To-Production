...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-24T23:46:06+00:00",
  "source_file": "README.md",
  "language_code": "sw"
}
-->
# Kujenga Wakala za AI Kutoka Sifuri hadi Uzalishaji

![Kujenga Wakala wa AI Kutoka Sifuri hadi Uzalishaji](../../translated_images/sw/repo-thumbnail.083b24afed61b6dd27a7fc53798bebe9edf688a41031163a1fca9f61c64d63ec.png)

### 🌐 Usaidizi wa Lugha Nyingi

#### Inasaidiwa kupitia GitHub Action (Imeotomatishwa & Daima Imewekwa Hivi Karibuni)
...
## Kozi inayokufundisha misingi ya Mwongozo wa Maendeleo ya Wakala wa AI
...
[![Pull requests za GitHub](https://img.shields.io/github/issues-pr/microsoft/Building-AI-Agents-From-Zero-To-Production.svg)](https://GitHub.com/microsoft/Building-AI-Agents-From-Zero-To-Production/pulls/?WT.mc_id=academic-105485-koreyst)
...
[![Discord ya Microsoft Foundry](https://dcbadge.limes.pink/api/server/nTYy5BXMWG)](https://discord.gg/Kuaw3ktsu6)

## 🌱 Kuanzia

Kozi hii ina masomo zinazofundisha misingi ya kujenga na kupeleka Wakala wa AI.

Kila somo linajengwa juu ya lile lililotangulia, hivyo tunapendekeza uanze tangu mwanzo na ujifunze hatua kwa hatua hadi mwisho.

Ikiwa ungependa kuchunguza zaidi kuhusu mada za Wakala wa AI, unaweza kuangalia [AI Agents For Beginenrs Course](https://aka.ms/ai-agents-beginners).

### Kutana na Wanafunzi Wengine, Pata Maswali Yako Yajibiwe

Ikiwa unatokea shida au una maswali kuhusu kujenga Wakala wa AI, jiunge na Kituo chetu maalum cha Discord katika [Microsoft Foundry Discord](https://discord.gg/Kuaw3ktsu6).

### Unachohitaji

Kila Somo lina sampuli yake ya msimbo ambayo unaweza kuendesha kwa eneo (locally). Unaweza [fork this repo](https://github.com/microsoft/Building-AI-Agents-From-Zero-To-Production/fork) kuunda nakala yako mwenyewe.
...
Tafadhali hakikisha una ufikiaji wa huduma hizi kabla ya kuanza.

Chaguzi zaidi kuhusu mwenyeji wa modeli na huduma zitatoka hivi karibuni. 

## 🗃️ Masomo

| **Somo**         | **Maelezo**                                                                                  |
|--------------------|--------------------------------------------------------------------------------------------------|
| [Agent Design](./lesson-1-agent-design/README.md)       | Utangulizi kwa kesi ya matumizi ya "Onboarding ya Developer" na jinsi ya kubuni wakala wenye ufanisi  |
| [Agent Development](./lesson-2-agent-development/README.md)  | Kutumia Microsoft Agent Framework (MAF), unda wakala 3 kusaidia waendelezaji wapya kujiingiza.       |
| [Agent Evaluations](./lesson-3-agent-evals/README.md)  | Kutumia Microsoft Foundry, gundua jinsi Wakala wetu wa AI wanavyofanya kazi na jinsi ya kuwaboresha. |
| [Agent Deployment](./lesson-4-agent-deployment/README.md)   | Kutumia Hosted Agents na OpenAI Chatkit, ona jinsi ya kupeleka Wakala wa AI kwenye uzalishaji.       |
...
Mradi huu unakaribisha michango na mapendekezo.  Michango mingi inahitaji wewe kukubali Makubaliano ya Leseni ya Mchangiaji (CLA) yanayothibitisha kwamba una haki, na kwa kweli unatoa, haki kwetu kutumia mchango wako. Kwa maelezo, tembelea <https://cla.opensource.microsoft.com>.

Unapowasilisha pull request, bot wa CLA utakagua moja kwa moja ikiwa unahitaji kutoa CLA na kuthibitisha PR ipasavyo (mf., ukaguzi wa hali, maoni). Fuata tu maelekezo yaliyotolewa na bot. Utahitaji kufanya hivi mara moja tu katika repos zote zinazotumia CLA yetu.

Mradi huu umekubali [Kanuni za Maadili za Chanzo Wazi za Microsoft](https://opensource.microsoft.com/codeofconduct/).
Kwa maelezo zaidi angalia [Maswali Yanayoulizwa Mara kwa Mara kuhusu Kanuni za Maadili](https://opensource.microsoft.com/codeofconduct/faq/) au wasiliana na [opencode@microsoft.com](mailto:opencode@microsoft.com) kwa maswali au maoni zaidi.

## Alama za Biashara

Mradi huu unaweza kuwa na alama za biashara au nembo za miradi, bidhaa, au huduma. Matumizi ya idhini ya alama za biashara au nembo za Microsoft yanategemea na lazima yafuatane na
[Mwongozo wa Alama za Microsoft & Vigezo vya Chapa](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general).
Matumizi ya alama za biashara au nembo za Microsoft katika toleo zilizobadilishwa za mradi huu hayapaswi kusababisha mkanganyiko au kupendekeza kuwa Microsoft inafadhili. Matumizi yoyote ya alama za biashara au nembo za wahusika wengine unatakiwa kufuata sera za wahusika hao.

## Kupata Msaada

Iwapo utakwama au una maswali yoyote kuhusu kujenga programu za AI, jiunge:
...
Nyaraka hii imetafsiriwa kwa kutumia huduma ya tafsiri kwa akili bandia [Co-op Translator](https://github.com/Azure/co-op-translator). Ingawa tunajitahidi kuwa sahihi, tafadhali fahamu kwamba tafsiri za kiotomatiki zinaweza kuwa na makosa au ukosefu wa usahihi. Nyaraka ya awali katika lugha yake ya asili inapaswa kuzingatiwa kama chanzo chenye mamlaka. Kwa habari muhimu, inashauriwa kutumia tafsiri ya kitaalamu inayofanywa na mtafsiri wa binadamu. Hatuwajibiki kwa kutoelewana au tafsiri potofu zitokanazo na matumizi ya tafsiri hii.
