# ゼロから製品化までのAIエージェント構築

![ゼロから製品化までのAIエージェント構築](../../translated_images/ja/repo-thumbnail.083b24afed61b6dd.webp)
...
> ```
>
> これにより、より高速なダウンロードでコースを完了するのに必要なものすべてが手に入ります。
...
このコースはAIエージェントの構築と展開の基本をカバーするレッスンがあります。

各レッスンは前のレッスンに基づいているので、最初から始めて最後まで進めることをおすすめします。

AIエージェントのトピックをもっと探求したい場合は、[AI Agents For Beginners Course](https://aka.ms/ai-agents-beginners)をご覧ください。

### 他の学習者と出会い、質問に答えてもらう

もし行き詰ったり、AIエージェント構築に関して質問がある場合は、[Microsoft Foundry Discord](https://discord.gg/Kuaw3ktsu6)の専用Discordチャンネルに参加してください。

### 必要なもの

各レッスンには、ローカルで実行できるコードサンプルがあります。[このリポジトリをフォーク](https://github.com/microsoft/Building-AI-Agents-From-Zero-To-Production/fork)して、自分のコピーを作成できます。
...
開始前にこれらのサービスにアクセスできることを確認してください。

モデルホスティングやサービスのさらなるオプションは近日公開予定です。
...
| [エージェント開発](./lesson-2-agent-development/README.md)  | Microsoft Agent Framework (MAF) を使用し、新人開発者のオンボーディング支援エージェントを3つ作成    |
| [エージェント評価](./lesson-3-agent-evals/README.md)           | Microsoft Foundry を使ってAIエージェントのパフォーマンス評価と改善方法を学ぶ                         |
| [エージェント展開](./lesson-4-agent-deployment/README.md)     | Hosted Agents と OpenAI Chatkit を使い、AIエージェントを製品にデプロイする方法を学ぶ                |
...
このプロジェクトは貢献や提案を歓迎します。ほとんどの貢献には、あなたが貢献する権利を有し、実際にその権利を当社に許諾することを宣言する
貢献者ライセンス契約（CLA）に同意する必要があります。詳細は<https://cla.opensource.microsoft.com>をご覧ください。

プルリクエストを提出すると、CLAボットが自動的にあなたがCLAの提供が必要かどうかを判定し、
プルリクエストに適切な装飾（例えばステータスチェックやコメント）を行います。ボットの指示に従うだけで大丈夫です。
当社のCLAを使うすべてのリポジトリでこれを一度行えば十分です。

このプロジェクトは [Microsoft Open Source Code of Conduct](https://opensource.microsoft.com/codeofconduct/) を採用しています。
詳細は [Code of Conduct FAQ](https://opensource.microsoft.com/codeofconduct/faq/) をご覧いただくか、
質問やコメントがある場合は [opencode@microsoft.com](mailto:opencode@microsoft.com) にお問い合わせください。

## 商標について

このプロジェクトには、プロジェクト、製品、またはサービスの商標やロゴが含まれている場合があります。Microsoftの商標やロゴの許可された使用は、
[Microsoftの商標およびブランドガイドライン](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general) に従う必要があります。
Microsoftの商標やロゴをこのプロジェクトの改変版で使用する際は、混乱を招くことやMicrosoftの支援を示唆することがないようにしてください。
サードパーティの商標やロゴの使用は、それら第三者のポリシーに従います。

## ヘルプを得るには

AIアプリの構築で行き詰まったり質問がある場合は、こちらに参加してください:

[![Microsoft Foundry Discord](https://dcbadge.limes.pink/api/server/nTYy5BXMWG)](https://discord.gg/Kuaw3ktsu6)

製品のフィードバックや構築時のエラーについては、こちらを訪問してください:
