# Izgradnja AI Agenta od Nule do Proizvodnje

![Izgradnja AI Agenta od Nule do Proizvodnje](../../translated_images/hr/repo-thumbnail.083b24afed61b6dd.webp)
...
>
> Ovaj repozitorij sadrži 50+ prijevoda jezika što značajno povećava veličinu preuzimanja. Za kloniranje bez prijevoda koristite sparse checkout:
>
> **Bash / macOS / Linux:**
> ```bash
...
> ```
>
> Ovo vam daje sve što vam treba za dovršetak tečaja uz puno brže preuzimanje.
...
Svaka lekcija nadograđuje prethodnu, stoga preporučujemo započeti od početka i proći kroz sve do kraja.

Ako želite istražiti više tema vezanih uz AI agente, možete pogledati [AI Agents For Beginners Course](https://aka.ms/ai-agents-beginners).
...
Svaka lekcija ima svoj primjer koda koji možete pokrenuti lokalno. Možete [forkati ovaj repozitorij](https://github.com/microsoft/Building-AI-Agents-From-Zero-To-Production/fork) da napravite vlastitu kopiju.

Trenutno ovaj tečaj koristi sljedeće:
...
Molimo osigurajte pristup ovim uslugama prije početka rada.

Više opcija vezanih za hosting modela i usluge uskoro dolazi.

## 🗃️ Lekcije

| **Lekcija**                   | **Opis**                                                                                                   |
|------------------------------|-----------------------------------------------------------------------------------------------------------|
| [Dizajn agenta](./lesson-1-agent-design/README.md)           | Uvod u naš slučaj korištenja "Developer Onboarding" agenta i kako dizajnirati učinkovite agente         |
| [Razvoj agenta](./lesson-2-agent-development/README.md)      | Korištenjem Microsoft Agent Frameworka (MAF) kreirajte 3 agenta koji pomažu novim programerima u onboardingu.     |
...
Ovaj projekt pozdravlja doprinos i prijedloge. Većina doprinosa zahtijeva da se složite s 
Ugovorom o licenci za suradnike (CLA) kojim izjavljujete da imate pravo i doista dajete nam
prava za korištenje vašeg doprinosa. Za detalje posjetite <https://cla.opensource.microsoft.com>.

Kada pošaljete zahtjev za promjenu (pull request), CLA bot će automatski odrediti trebate li
dostaviti CLA i odgovarajuće označiti PR (npr. provjera statusa, komentar). Jednostavno slijedite
upute koje daje bot. To trebate napraviti samo jednom za sve repozitorije koji koriste naš CLA.
...
[Microsoftova pravila o zaštitnim znakovima i brendiranju](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general).
Korištenje Microsoftovih zaštitnih znakova ili logotipa u izmijenjenim verzijama ovog projekta ne smije izazvati zbunjenost niti implicirati Microsoftovo sponzorstvo.
