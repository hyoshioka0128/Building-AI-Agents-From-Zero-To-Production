...
> **Norite kloonuoti vietoje?**

> Ši saugykla apima daugiau nei 50 kalbų vertimų, dėl to padidėja atsisiuntimo dydis. Norėdami kopijuoti be vertimų, naudokite sparse checkout:
> ```bash
...
## Kursas, mokantis AI agentų kūrimo pagrindus
...
[![GitHub indėlininkai](https://img.shields.io/github/contributors/microsoft/Building-AI-Agents-From-Zero-To-Production.svg)](https://GitHub.com/microsoft/Building-AI-Agents-From-Zero-To-Production/graphs/contributors/?WT.mc_id=academic-105485-koreyst)
...
[![GitHub pull-ūskaitimai](https://img.shields.io/github/issues-pr/microsoft/Building-AI-Agents-From-Zero-To-Production.svg)](https://GitHub.com/microsoft/Building-AI-Agents-From-Zero-To-Production/pulls/?WT.mc_id=academic-105485-koreyst)
[![PRs kviečiami](https://img.shields.io/badge/PRs-welcome-brightgreen.svg?style=flat-square)](http://makeapullrequest.com?WT.mc_id=academic-105485-koreyst)

[![Microsoft Foundry Discord](https://dcbadge.limes.pink/api/server/nTYy5BXMWG)](https://discord.gg/Kuaw3ktsu6)

## 🌱 Pradžia

Šiame kurse yra pamokų, apimančių AI agentų kūrimo ir diegimo pagrindus.

Kiekviena pamoka statoma ant ankstesnės, todėl rekomenduojame pradėti nuo pradžių ir eiti iki pabaigos.

Jei norite daugiau sužinoti apie AI agentų temas, galite peržiūrėti [AI Agents For Beginners kursą](https://aka.ms/ai-agents-beginners).

### Susipažinkite su kitais besimokančiais, gaukite atsakymus į savo klausimus

Jei susiduriate su sunkumais arba turite klausimų apie AI agentų kūrimą, prisijunkite prie mūsų specialaus Discord kanalo [Microsoft Foundry Discord](https://discord.gg/Kuaw3ktsu6).

### Ko jums reikia

Kiekviena pamoka turi savo kodo pavyzdį, kurį galite paleisti vietoje. Galite [padaryti šio repozitorijaus atšaką](https://github.com/microsoft/Building-AI-Agents-From-Zero-To-Production/fork) ir sukurti savo kopiją.
...
Įsitikinkite, kad turite prieigą prie šių paslaugų prieš pradedant.

Netolimoje ateityje planuojamos daugiau modelių talpinimo ir paslaugų galimybių.

## 🗃️ Pamokos

| **Pamoka**         | **Aprašymas**                                                                                  |
|--------------------|--------------------------------------------------------------------------------------------------|
| [Agentų dizainas](./lesson-1-agent-design/README.md)       | Įvadas į mūsų "Kūrėjų įvedimo" agentų naudojimo atvejį ir kaip kurti veiksmingus agentus  |
| [Agentų kūrimas](./lesson-2-agent-development/README.md)  | Naudojant Microsoft Agent Framework (MAF) sukurkite 3 agentus, kurie padeda naujiems kūrėjams įsitraukti.       |
| [Agentų vertinimas](./lesson-3-agent-evals/README.md)  | Naudojant Microsoft Foundry sužinokite, kaip gerai veikia mūsų AI agentai ir kaip juos pagerinti. |
| [Agentų diegimas](./lesson-4-agent-deployment/README.md)   | Naudojant Hosted Agents ir OpenAI Chatkit, sužinokite, kaip diegti AI agentą gamybos aplinkoje.       |
...
Šis projektas laukia indėlių ir pasiūlymų. Daugeliu atvejų indėliai reikalauja, kad sutiktumėte su Kontributoriaus licencijos sutartimi (CLA), kurioje nurodote, kad turite teisę ir iš tikrųjų suteikiate mums teises naudoti jūsų indėlį. Daugiau informacijos rasite <https://cla.opensource.microsoft.com>.

Pateikus pull request, CLA robotas automatiškai nustatys, ar jums reikia pateikti CLA ir tinkamai pažymės PR (pvz., būsenos patikrinimą, komentarą). Paprasčiausiai sekite roboto nurodymus. Tai reikės padaryti tik vieną kartą visiems mūsų CLA naudojamiems saugykloms.

Šis projektas priėmė [Microsoft atvirojo kodo elgesio kodeksą](https://opensource.microsoft.com/codeofconduct/).
Daugiau informacijos žr. [Elgesio kodekso DUK](https://opensource.microsoft.com/codeofconduct/faq/) arba susisiekite su [opencode@microsoft.com](mailto:opencode@microsoft.com) dėl papildomų klausimų ar komentarų.

## Prekių ženklai

Šiame projekte gali būti prekių ženklų arba logotipų, skirtų projektams, produktams ar paslaugoms. Leidžiamas „Microsoft“ prekių ženklų ar logotipų naudojimas yra reglamentuojamas ir turi atitikti [Microsoft prekių ženklų ir prekės ženklo gaires](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general).
„Microsoft“ prekių ženklų arba logotipų naudojimas šio projekto modifikuotose versijose neturėtų sukelti painiavos ar reikšti „Microsoft“ rėmimo.
Bet koks trečiųjų šalių prekių ženklų ar logotipų naudojimas yra reglamentuojamas tų trečiųjų šalių taisyklių.

## Pagalbos gavimas

Jei užstrigote ar turite klausimų apie dirbtinio intelekto programų kūrimą, prisijunkite prie:

[![Microsoft Foundry Discord](https://dcbadge.limes.pink/api/server/nTYy5BXMWG)](https://discord.gg/Kuaw3ktsu6)

Jei turite produkto atsiliepimų arba aptinkate klaidų kūrimo metu, apsilankykite:
...
Šis dokumentas buvo išverstas naudojant dirbtinio intelekto vertimo paslaugą [Co-op Translator](https://github.com/Azure/co-op-translator). Nors stengiamės užtikrinti tikslumą, prašome atkreipti dėmesį, kad automatizuoti vertimai gali turėti klaidų ar netikslumų. Originalus dokumentas jo gimtąja kalba turi būti laikomas autoritetingu šaltiniu. Svarbiai informacijai rekomenduojama atlikti profesionalų žmogaus vertimą. Mes neatsakome už bet kokius nesusipratimus ar klaidingas interpretacijas, kylančias dėl šio vertimo naudojimo.
