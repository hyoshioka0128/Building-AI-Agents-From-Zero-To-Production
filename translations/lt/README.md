...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-25T00:07:30+00:00",
...
[![GitHub prisidėtojai](https://img.shields.io/github/contributors/microsoft/Building-AI-Agents-From-Zero-To-Production.svg)](https://GitHub.com/microsoft/Building-AI-Agents-From-Zero-To-Production/graphs/contributors/?WT.mc_id=academic-105485-koreyst)
...
[![PR kviečiami](https://img.shields.io/badge/PRs-welcome-brightgreen.svg?style=flat-square)](http://makeapullrequest.com?WT.mc_id=academic-105485-koreyst)
...
Kiekviena pamoka remiasi ankstesne, todėl rekomenduojame pradėti nuo pradžių ir eiti iki galo.

Jei norite daugiau sužinoti apie AI agentų temas, galite peržiūrėti [Kursą „AI agentai pradedantiesiems“](https://aka.ms/ai-agents-beginners).

### Susipažinkite su kitais besimokančiais, gaukite atsakymus į savo klausimus

Jei užstrigsite arba turėsite klausimų apie AI agentų kūrimą, prisijunkite prie mūsų skirto Discord kanalo [Microsoft Foundry Discord](https://discord.gg/Kuaw3ktsu6).

### Ko jums reikia

Kiekviena pamoka turi savo kodo pavyzdį, kurį galite paleisti lokaliai. Galite [forkinti šį repozitorijų](https://github.com/microsoft/Building-AI-Agents-From-Zero-To-Production/fork) ir sukurti savo kopiją.
...
Netrukus bus daugiau parinkčių dėl modelių talpinimo ir paslaugų. 

## 🗃️ Pamokos

| **Pamoka**         | **Aprašymas**                                                                                  |
|--------------------|--------------------------------------------------------------------------------------------------|
| [Agentų dizainas](./lesson-1-agent-design/README.md)       | Įvadas į mūsų "Developer Onboarding" agento naudojimo atvejį ir į tai, kaip projektuoti veiksmingus agentus  |
| [Agentų kūrimas](./lesson-2-agent-development/README.md)  | Naudodami Microsoft Agent Framework (MAF), sukurkite 3 agentus, kurie padėtų naujiems kūrėjams pradėti darbą.       |
| [Agentų vertinimai](./lesson-3-agent-evals/README.md)  | Naudodami Microsoft Foundry sužinokite, kaip gerai veikia mūsų AI agentai ir kaip juos pagerinti. |
| [Agentų diegimas](./lesson-4-agent-deployment/README.md)   | Naudodami Hosted Agents ir OpenAI Chatkit pažiūrėkite, kaip diegti AI agentą į gamybą.       |
...
Šis projektas kviečia prisidėti ir teikti pasiūlymus. Daugumai indėlių reikės, kad sutiktumėte su Bendradarbio licencijos sutartimi (Contributor License Agreement, CLA), kurioje nurodoma, jog turite teisę ir iš tikrųjų suteikiate mums teises naudoti jūsų indėlį. Dėl išsamesnės informacijos apsilankykite <https://cla.opensource.microsoft.com>.

Kai pateiksite pull request, CLA robotas automatiškai nustatys, ar turite pateikti CLA, ir atitinkamai pažymės PR (pvz., būsenos patikrinimas, komentaras). Tiesiog vykdykite roboto nurodymus. Tai reikės padaryti tik vieną kartą visuose saugyklose (repos), naudojančiose mūsų CLA.

Šis projektas priėmė [Microsoft Open Source Code of Conduct](https://opensource.microsoft.com/codeofconduct/). Daugiau informacijos rasite [Code of Conduct FAQ](https://opensource.microsoft.com/codeofconduct/faq/) arba susisiekite su [opencode@microsoft.com](mailto:opencode@microsoft.com) dėl papildomų klausimų ar pastabų.

## Prekės ženklai

Šis projektas gali turėti projektų, produktų ar paslaugų prekės ženklus arba logotipus. Leidžiami Microsoft prekės ženklų ar logotipų naudojimo atvejai yra reglamentuojami ir turi atitikti [Microsoft's Trademark & Brand Guidelines](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general). Microsoft prekės ženklų ar logotipų naudojimas modifikuotose šio projekto versijose neturi sukelti painiavos ar reikšti Microsoft rėmimą. Bet koks trečiųjų šalių prekės ženklų ar logotipų naudojimas turi atitikti tų trečiųjų šalių taisykles.
...
Šis dokumentas buvo išverstas naudojant dirbtinio intelekto vertimo paslaugą [Co-op Translator](https://github.com/Azure/co-op-translator). Nors stengiamės užtikrinti tikslumą, atkreipkite dėmesį, kad automatizuoti vertimai gali turėti klaidų ar netikslumų. Originalus dokumentas jo gimtąja kalba turėtų būti laikomas pagrindiniu šaltiniu. Esant kritinei informacijai rekomenduojamas profesionalus žmogaus vertimas. Mes neatsakome už bet kokius nesusipratimus ar neteisingus aiškinimus, kylančius dėl šio vertimo naudojimo.
