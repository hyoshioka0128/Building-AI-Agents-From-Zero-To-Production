...
> Šioje saugykloje yra daugiau nei 50 kalbų vertimų, kurie reikšmingai didina atsisiuntimo dydį. Norėdami klonuoti be vertimų, naudokite retą patikrinimą (sparse checkout):
> ```bash
> git clone --filter=blob:none --sparse https://github.com/microsoft/Building-AI-Agents-From-Zero-To-Production.git
> cd Building-AI-Agents-From-Zero-To-Production
> git sparse-checkout set --no-cone '/*' '!translations' '!translated_images'
> ```
> Tai suteikia viską, ko reikia užbaigti kursą daug greičiau atsisiunčiant.
<!-- CO-OP TRANSLATOR LANGUAGES TABLE END -->

## Kursas, mokantis AI agentų kūrimo pagrindus ir gyvavimo ciklą
...
[![GitHub pakeitimų užklausos](https://img.shields.io/github/issues-pr/microsoft/Building-AI-Agents-From-Zero-To-Production.svg)](https://GitHub.com/microsoft/Building-AI-Agents-From-Zero-To-Production/pulls/?WT.mc_id=academic-105485-koreyst)
[![Prašymai pridedami mielai](https://img.shields.io/badge/PRs-welcome-brightgreen.svg?style=flat-square)](http://makeapullrequest.com?WT.mc_id=academic-105485-koreyst)

[![Microsoft Foundry Discord](https://dcbadge.limes.pink/api/server/nTYy5BXMWG)](https://discord.gg/Kuaw3ktsu6)

## 🌱 Pradžia

Šiame kurse pateikiamos pamokos apie AI agentų kūrimo ir diegimo pagrindus.

Kiekviena pamoka statosi ant ankstesnės, todėl rekomenduojame pradėti nuo pradžių ir eiti iki pabaigos.
...
Jei stringate ar turite klausimų apie AI agentų kūrimą, prisijunkite prie mūsų dedikuoto Discord kanalo [Microsoft Foundry Discord](https://discord.gg/Kuaw3ktsu6).

### Ko jums reikia

Kiekviena pamoka turi savo kodo pavyzdį, kurį galite paleisti vietoje. Galite [padalinti šią saugyklą](https://github.com/microsoft/Building-AI-Agents-From-Zero-To-Production/fork) ir sukurti savo kopiją.
...
Įsitikinkite, kad turite prieigą prie šių paslaugų prieš pradėdami.

Netolimoje ateityje bus daugiau modelių talpinimo ir paslaugų galimybių.

## 🗃️ Pamokos

| **Pamoka**          | **Aprašymas**                                                                                   |
|---------------------|------------------------------------------------------------------------------------------------|
| [Agentų dizainas](./lesson-1-agent-design/README.md)         | Įvadas į mūsų "Kūrėjo įvedimas" agentų panaudojimo atvejį ir kaip kurti efektyvius agentus      |
| [Agentų kūrimas](./lesson-2-agent-development/README.md)    | Naudojant Microsoft Agent Framework (MAF), sukurkite 3 agentus, kurie padeda naujiems kūrėjams.  |
| [Agentų įvertinimai](./lesson-3-agent-evals/README.md)       | Naudojant Microsoft Foundry, sužinokite, kaip gerai veikia mūsų AI agentai ir kaip juos tobulinti.|
| [Agentų diegimas](./lesson-4-agent-deployment/README.md)     | Naudojant talpinamus agentus ir OpenAI Chatkit, sužinokite, kaip įdiegti AI agentą į gamybą.   |
...
[![Daiktų internetas (IoT) pradedantiesiems](https://img.shields.io/badge/IoT%20for%20Beginners-14B8A6?style=for-the-badge&labelColor=E5E7EB&color=14B8A6)](https://aka.ms/iot-beginners?WT.mc_id=academic-105485-koreyst)
[![Išplėstinės realybės (XR) kūrimas pradedantiesiems](https://img.shields.io/badge/XR%20Development%20for%20Beginners-38BDF8?style=for-the-badge&labelColor=E5E7EB&color=38BDF8)](https://github.com/microsoft/xr-development-for-beginners?WT.mc_id=academic-105485-koreyst)

---
 
### Copilot serija
[![Copilot skirta AI poriniam programavimui](https://img.shields.io/badge/Copilot%20for%20AI%20Paired%20Programming-FACC15?style=for-the-badge&labelColor=E5E7EB&color=FACC15)](https://aka.ms/GitHubCopilotAI?WT.mc_id=academic-105485-koreyst)
[![Copilot skirta C#/.NET](https://img.shields.io/badge/Copilot%20for%20C%23/.NET-FBBF24?style=for-the-badge&labelColor=E5E7EB&color=FBBF24)](https://github.com/microsoft/mastering-github-copilot-for-dotnet-csharp-developers?WT.mc_id=academic-105485-koreyst)
...
Šis projektas laukią indėlių ir pasiūlymų. Dauguma indėlių reikalauja sutikimo su
Indėlio teisių sutartimi (Contributor License Agreement, CLA), kurioje deklaruojate, kad turite teisę ir iš tikrųjų suteikiate mums
teisę naudoti jūsų indėlį. Daugiau informacijos rasite <https://cla.opensource.microsoft.com>.

Pateikus pull request’ą, CLA robotas automatiškai nustatys, ar jums reikia pateikti
CLA, ir žymės PR tinkamai (pvz., statuso patikrinimu, komentaru). Tiesiog sekite roboto nurodymus.
...
kreipkitės el. paštu [opencode@microsoft.com](mailto:opencode@microsoft.com) su papildomais klausimais ar pastebėjimais.

## Prekių ženklai

Šiame projekte gali būti prekių ženklų ar logotipų projektams, produktams ar paslaugoms. Leidžiama naudoti
Microsoft prekių ženklus ar logotipus tik laikantis
...
Keistos projekto versijos, kuriose naudojami Microsoft prekių ženklai ar logotipai, negali sukelti painiavos ar rodyti Microsoft rėmimą.
Bet koks trečiųjų šalių prekių ženklų ar logotipų naudojimas priklauso tų trečiųjų šalių taisyklėms.

## Pagalba

Jei stringate ar turite klausimų apie AI programų kūrimą, prisijunkite prie:
