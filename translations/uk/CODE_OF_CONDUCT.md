...
- Звертайтеся за адресою [opencode@microsoft.com](mailto:opencode@microsoft.com) з питаннями або зауваженнями
- Співробітники можуть звертатися за посиланням [aka.ms/opensource/moderation-support](https://aka.ms/opensource/moderation-support)
