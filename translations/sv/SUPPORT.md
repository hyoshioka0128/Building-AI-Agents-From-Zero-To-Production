...
- **Ja till CSS-support:** Fyll i ett intagningsformulär på [aka.ms/onboardsupport](https://aka.ms/onboardsupport). CSS kommer att arbeta med/dig för att bestämma nästa steg.
...
För hjälp och frågor om att använda detta projekt, vänligen **REPOUNDERHÅLLARE: INFÖR INSTRUKTIONER HÄR 
FÖR HUR MAN KONTAKTAR REPOÄGARE ELLER GEMENSKAPEN FÖR HJÄLP. KAN VARA EN STACK OVERFLOW-TAGG ELLER ANNAN
KANAL. VAR KOMMER DU ATT HJÄLPA FOLK?**.

## Microsofts supportpolicy  

Support för detta **PROJEKT eller PRODUKT** är begränsad till de resurser som listas ovan.
