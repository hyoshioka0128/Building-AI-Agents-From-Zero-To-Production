...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2026-01-16T09:04:54+00:00",
...
> Detta repo inkluderar över 50 översättningar vilket ökar nedladdningsstorleken avsevärt. För att klona utan översättningar, använd sparsamt utcheckning:
> ```bash
> git clone --filter=blob:none --sparse https://github.com/microsoft/Building-AI-Agents-From-Zero-To-Production.git
> cd Building-AI-Agents-From-Zero-To-Production
> git sparse-checkout set --no-cone '/*' '!translations' '!translated_images'
> ```
> Det ger dig allt du behöver för att slutföra kursen med en mycket snabbare nedladdning.
...
[![GitHub-bidragande](https://img.shields.io/github/contributors/microsoft/Building-AI-Agents-From-Zero-To-Production.svg)](https://GitHub.com/microsoft/Building-AI-Agents-From-Zero-To-Production/graphs/contributors/?WT.mc_id=academic-105485-koreyst)
...
Om du vill utforska mer om AI-agentämnen kan du kolla in [AI Agents For Beginners-kursen](https://aka.ms/ai-agents-beginners).

### Träffa andra inlärare, få dina frågor besvarade
...
| **Lektion**         | **Beskrivning**                                                                                  |
|---------------------|--------------------------------------------------------------------------------------------------|
| [Agentdesign](./lesson-1-agent-design/README.md)       | En introduktion till vårt "Developer Onboarding"-agentanvändningsfall och hur man designar effektiva agenter  |
| [Agentutveckling](./lesson-2-agent-development/README.md)  | Med Microsoft Agent Framework (MAF), skapa 3 agenter för att hjälpa nya utvecklare att komma igång.       |
| [Agentutvärderingar](./lesson-3-agent-evals/README.md)  | Med Microsoft Foundry, ta reda på hur väl våra AI-agenter presterar och hur man förbättrar dem. |
| [Agentdistribution](./lesson-4-agent-deployment/README.md)   | Med Hostade agenter och OpenAI Chatkit, se hur man distribuerar en AI-agent i produktion.       |
...
Bidragsgivaravtal (CLA) som deklarerar att du har rätt att, och faktiskt gör, ge oss
...
en CLA och markera PR lämpligt (t.ex. statuskontroll, kommentar). Följ helt enkelt instruktionerna
...
**Ansvarsfriskrivning**:
Detta dokument har översatts med hjälp av AI-översättningstjänsten [Co-op Translator](https://github.com/Azure/co-op-translator). Även om vi strävar efter noggrannhet, bör du vara medveten om att automatiska översättningar kan innehålla fel eller brister. Originaldokumentet på dess ursprungsspråk ska betraktas som den auktoritativa källan. För viktig information rekommenderas professionell mänsklig översättning. Vi ansvarar inte för några missförstånd eller feltolkningar som uppstår till följd av användningen av denna översättning.
