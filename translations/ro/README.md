...
#### Disponibil prin GitHub Action (Automatizat și Întotdeauna Actualizat)
...
> ```
>
> Astfel, ai tot ce îți trebuie pentru a finaliza cursul cu o descărcare mult mai rapidă.
<!-- CO-OP TRANSLATOR LANGUAGES TABLE END -->

## Un curs care te învață elementele fundamentale ale ciclului de viață pentru dezvoltarea Agenților AI
...
Acest curs are lecții care acoperă elementele fundamentale în construirea și implementarea Agenților AI.

Fiecare lecție se bazează pe cea precedentă, așa că recomandăm să începi de la început și să parcurgi până la final.

Dacă dorești să explorezi mai mult subiectele despre Agenții AI, poți verifica [Cursul pentru Începători AI Agents](https://aka.ms/ai-agents-beginners).

### Cunoaște Alți Cursanți, Primește Răspunsuri la Întrebările Tale

Dacă întâmpini dificultăți sau ai întrebări despre construirea Agenților AI, alătură-te canalului nostru dedicat de Discord din [Microsoft Foundry Discord](https://discord.gg/Kuaw3ktsu6).

### Ce Ai Nevoie

Fiecare lecție are propriul său exemplu de cod pe care îl poți rula local. Poți [face fork acestui repo](https://github.com/microsoft/Building-AI-Agents-From-Zero-To-Production/fork) pentru a-ți crea o copie personală.
...
| **Lecția**         | **Descriere**                                                                                  |
|--------------------|--------------------------------------------------------------------------------------------------|
| [Designul Agentului](./lesson-1-agent-design/README.md)       | O introducere în cazul de utilizare „Developer Onboarding” și cum să proiectezi agenți eficienți  |
| [Dezvoltarea Agentului](./lesson-2-agent-development/README.md)  | Folosind Microsoft Agent Framework (MAF), creează 3 agenți care să ajute dezvoltatorii noi să se onboardeze.       |
| [Evaluările Agentului](./lesson-3-agent-evals/README.md)  | Folosind Microsoft Foundry, află cât de bine performează Agenții AI și cum îi poți îmbunătăți. |
...
Acord de Licență pentru Contribuitori (CLA) care declară că aveți dreptul, și într-adevăr acordați,
...
un CLA și va decora PR-ul corespunzător (de ex., verificare de status, comentariu). Urmați pur și simplu instrucțiunile
date de bot. Trebuie să faceți acest lucru o singură dată pentru toate repo-urile care folosesc CLA-ul nostru.

Acest proiect a adoptat [Codul de Conduită Open Source Microsoft](https://opensource.microsoft.com/codeofconduct/).
Pentru mai multe informații vedeți [FAQ Codului de Conduită](https://opensource.microsoft.com/codeofconduct/faq/) sau
...
[Ghidul Microsoft privind Mărcile înregistrate și Brandul](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general).
Folosirea mărcilor sau siglelor Microsoft în versiuni modificate ale acestui proiect nu trebuie să cauzeze confuzie sau să implice sponsorizare Microsoft.
Orice utilizare a mărcilor comerciale sau siglelor terțe este supusă politicilor acelor terți.

## Obținerea ajutorului

Dacă întâmpinați probleme sau aveți întrebări despre construirea aplicațiilor AI, alăturați-vă:
