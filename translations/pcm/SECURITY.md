...
Microsoft dey take the security of our software products and services serious, wey include all source code repositories for our GitHub organizations.

**Abeg no report security vulnerabilities through public GitHub issues.**

For security reporting information, locations, contact information, and policies, abeg check the latest guidance for Microsoft repositories for [https://aka.ms/SECURITY.md](https://aka.ms/SECURITY.md).
