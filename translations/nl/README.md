...
>
> Deze repository bevat meer dan 50 vertalingen, wat de downloadgrootte aanzienlijk verhoogt. Om zonder vertalingen te clonen, gebruik je sparse checkout:
>
> **Bash / macOS / Linux:**
> ```bash
...
Deze cursus bevat lessen over de basisprincipes van het bouwen en inzetten van AI-agenten.

Elke les bouwt voort op de vorige, daarom raden we aan vanaf het begin te starten en stap voor stap door te werken tot het einde.

Wil je meer ontdekken over AI-agenten, bekijk dan de [AI Agents For Beginners Course](https://aka.ms/ai-agents-beginners).
...
Elke les heeft zijn eigen codesample die je lokaal kunt uitvoeren. Je kunt deze repo [forken](https://github.com/microsoft/Building-AI-Agents-From-Zero-To-Production/fork) om je eigen kopie te maken.

Deze cursus maakt momenteel gebruik van:
...
Zorg dat je toegang hebt tot deze diensten voordat je begint.

Meer opties rondom modelhosting en services volgen binnenkort.
...
| [Agentontwikkeling](./lesson-2-agent-development/README.md)  | Met het Microsoft Agent Framework (MAF) maak je 3 agenten om nieuwe ontwikkelaars te ondersteunen bij onboarding. |
| [Agentevaluaties](./lesson-3-agent-evals/README.md)  | Met Microsoft Foundry ontdek je hoe goed onze AI-agenten presteren en hoe je ze kunt verbeteren.   |
| [Agentuitrol](./lesson-4-agent-deployment/README.md)   | Met behulp van gehoste agenten en OpenAI Chatkit leer je hoe je een AI-agent in productie brengt.   |


## 🎒 Andere cursussen

Ons team maakt ook andere cursussen! Kijk eens naar:
...
de rechten om je bijdrage te gebruiken. Voor details, bezoek <https://cla.opensource.microsoft.com>.

Wanneer je een pull request indient, zal een CLA-bot automatisch bepalen of je een
CLA moet aanleveren en de PR geschikt markeren (bijv. statuscontrole, commentaar). Volg gewoon de instructies
...
Dit project kan handelsmerken of logo's bevatten van projecten, producten of diensten. Toegestaan gebruik van Microsoft
