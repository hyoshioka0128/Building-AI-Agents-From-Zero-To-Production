...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-24T23:34:26+00:00",
...
## Een cursus die je de basisprincipes van de levenscyclus van AI-agentontwikkeling leert
...
[![GitHub-pullverzoeken](https://img.shields.io/github/issues-pr/microsoft/Building-AI-Agents-From-Zero-To-Production.svg)](https://GitHub.com/microsoft/Building-AI-Agents-From-Zero-To-Production/pulls/?WT.mc_id=academic-105485-koreyst)
...
Deze cursus bevat lessen over de basisprincipes van het bouwen en inzetten van AI-agents.

Elke les bouwt voort op de vorige, dus we raden aan om bij het begin te beginnen en helemaal door te werken tot het einde.

Als je meer wilt ontdekken over AI-agentonderwerpen, kun je de [AI Agents voor Beginners Cursus](https://aka.ms/ai-agents-beginners) bekijken.

### Ontmoet andere leerlingen, krijg antwoord op je vragen

Als je vastloopt of vragen hebt over het bouwen van AI-agents, sluit je aan bij ons speciale Discord-kanaal in de [Microsoft Foundry Discord](https://discord.gg/Kuaw3ktsu6).

### Wat je nodig hebt

Elke les heeft een eigen codevoorbeeld dat je lokaal kunt uitvoeren. Je kunt [dit repo forken](https://github.com/microsoft/Building-AI-Agents-From-Zero-To-Production/fork) om je eigen kopie te maken.
...
Meer opties voor modelhosting en services volgen binnenkort. 

## 🗃️ Lessen

| **Les**         | **Beschrijving**                                                                                  |
|--------------------|--------------------------------------------------------------------------------------------------|
| [Agentontwerp](./lesson-1-agent-design/README.md)       | Een introductie tot onze "Developer Onboarding" use case en hoe je effectieve agents ontwerpt  |
| [Agentontwikkeling](./lesson-2-agent-development/README.md)  | Gebruik het Microsoft Agent Framework (MAF) om 3 agents te maken die nieuwe ontwikkelaars helpen inwerken.       |
| [Agentbeoordelingen](./lesson-3-agent-evals/README.md)  | Gebruik Microsoft Foundry om te ontdekken hoe goed onze AI-agents presteren en hoe je ze kunt verbeteren. |
| [Agentimplementatie](./lesson-4-agent-deployment/README.md)   | Gebruik de Hosted Agents en OpenAI Chatkit om te zien hoe je een AI-agent in productie inzet.       |
...
### Copilot-serie
[![Copilot voor AI-ondersteund pair programming](https://img.shields.io/badge/Copilot%20for%20AI%20Paired%20Programming-FACC15?style=for-the-badge&labelColor=E5E7EB&color=FACC15)](https://aka.ms/GitHubCopilotAI?WT.mc_id=academic-105485-koreyst)
...
Dit project verwelkomt bijdragen en suggesties. De meeste bijdragen vereisen dat u akkoord gaat met een Bijdragerslicentieovereenkomst (CLA) waarin u verklaart dat u het recht hebt en daadwerkelijk aan ons de rechten verleent om uw bijdrage te gebruiken. Voor details, bezoek <https://cla.opensource.microsoft.com>.

Wanneer u een pull request indient, zal een CLA-bot automatisch bepalen of u een CLA moet indienen en het PR dienovereenkomstig markeren (bijv. statuscontrole, opmerking). Volg eenvoudigweg de instructies van de bot. U hoeft dit slechts één keer te doen voor alle repositories die onze CLA gebruiken.

Dit project heeft de [Microsoft Open Source Gedragscode](https://opensource.microsoft.com/codeofconduct/) overgenomen. Voor meer informatie zie de [Veelgestelde vragen over de gedragscode](https://opensource.microsoft.com/codeofconduct/faq/) of neem contact op met [opencode@microsoft.com](mailto:opencode@microsoft.com) als u nog vragen of opmerkingen heeft.

## Handelsmerken

Dit project kan handelsmerken of logo's bevatten van projecten, producten of diensten. Toegestaan gebruik van Microsoft-handelsmerken of logo's is onderhevig aan en moet voldoen aan de [Microsofts richtlijnen voor handelsmerken en merkgebruik](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general). Het gebruik van Microsoft-handelsmerken of logo's in gewijzigde versies van dit project mag geen verwarring veroorzaken of impliceren dat Microsoft het sponsort. Elk gebruik van handelsmerken of logo's van derden is onderhevig aan het beleid van die derden.
...
Als u productfeedback of fouten ervaart tijdens het bouwen, bezoek:
