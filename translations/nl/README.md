...
## Een cursus die de basisprincipes van de levenscyclus van AI-agentontwikkeling leert
...
Deze cursus bevat lessen die de basisprincipes behandelen van het bouwen en implementeren van AI-agents.
...
Elke les heeft zijn eigen codevoorbeeld dat je lokaal kunt uitvoeren. Je kunt [deze repo forken](https://github.com/microsoft/Building-AI-Agents-From-Zero-To-Production/fork) om een eigen kopie te maken.
...
Meer opties rond modelhosting en services volgen snel.
...
| [Agentontwikkeling](./lesson-2-agent-development/README.md) | Met behulp van het Microsoft Agent Framework (MAF), creëer 3 agents die nieuwe ontwikkelaars helpen onboarden.       |
| [Agentevaluaties](./lesson-3-agent-evals/README.md)      | Gebruik Microsoft Foundry om te ontdekken hoe goed onze AI-agents presteren en hoe je ze kunt verbeteren. |
| [Agentimplementatie](./lesson-4-agent-deployment/README.md) | Met Hosted Agents en OpenAI Chatkit, leer hoe je een AI-agent in productie brengt.       |
...
Voor meer informatie, zie de [Gedragscode FAQ](https://opensource.microsoft.com/codeofconduct/faq/) of neem contact op met [opencode@microsoft.com](mailto:opencode@microsoft.com) bij extra vragen of opmerkingen.
...
[Microsoft's Richtlijnen voor Handelsmerken en Merken](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general).
Het gebruik van Microsoft handelsmerken of logo's in gewijzigde versies van dit project mag geen verwarring veroorzaken of een Microsoft-sponsoring impliceren.
