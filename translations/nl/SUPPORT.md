...
- **Geen CSS-ondersteuning:** Vul deze template in met informatie over hoe u problemen kunt melden en hulp kunt krijgen.
...
issues voordat u nieuwe aanmaakt om duplicaten te voorkomen. Voor nieuwe issues, meld uw bug of 
functieverzoek als een nieuw Issue.

Voor hulp en vragen over het gebruik van dit project, **REPO BEHEERDER: VOEG HIER INSTRUCTIES TOE 
OVER HOE U REPO-EIGENAREN OF DE COMMUNITY KUNT BENADEREN VOOR HULP. DIT KAN EEN STACK OVERFLOW TAG OF EEN ANDER
KANAAL ZIJN. WAAR GAAT U MENSEN HELPEN?**.

## Microsoft Ondersteuningsbeleid  

Ondersteuning voor dit **PROJECT of PRODUCT** is beperkt tot de hierboven vermelde middelen.
