...
on an A2A HTTP application. See [`a2a_server.py`](../../../lesson-7-multi-agent-a2a/a2a_server.py). The key wiring:
...
exactly like a local agent. See [`a2a_client.py`](../../../lesson-7-multi-agent-a2a/a2a_client.py):
...
```bash
# Terminal 1 — launch the A2A service
