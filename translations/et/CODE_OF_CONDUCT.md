...
- [Microsofti käitumisjuhendi korduma kippuvad küsimused](https://opensource.microsoft.com/codeofconduct/faq/)
- Küsimuste või murede korral võtke ühendust aadressil [opencode@microsoft.com](mailto:opencode@microsoft.com)
- Töötajad saavad pöörduda aadressil [aka.ms/opensource/moderation-support](https://aka.ms/opensource/moderation-support)
