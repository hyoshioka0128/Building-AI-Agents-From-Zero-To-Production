...
- **با پشتیبانی CSS:** فرم پذیرش را در [aka.ms/onboardsupport](https://aka.ms/onboardsupport) پر کنید. CSS با شما همکاری خواهد کرد/کمک می‌کند تا مراحل بعدی را تعیین کنید.
- **مطمئن نیستید؟** فرم پذیرش را طوری پر کنید که انگار پاسخ "بله" است. CSS به شما در تصمیم‌گیری کمک خواهد کرد.
...
برای کمک و سوالات درباره استفاده از این پروژه، لطفاً **نگهدارنده مخزن: دستورالعمل‌های مربوط به نحوه تعامل با مالکان مخزن یا جامعه برای دریافت کمک را اینجا وارد کنید. می‌تواند یک برچسب Stack Overflow یا کانال دیگری باشد. کجا به مردم کمک خواهید کرد؟**.
