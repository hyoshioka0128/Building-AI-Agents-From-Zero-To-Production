# קוד התנהגות קוד פתוח של מיקרוסופט
...
- צרו קשר בכתובת [opencode@microsoft.com](mailto:opencode@microsoft.com) עם שאלות או חששות
- עובדים יכולים לפנות בכתובת [aka.ms/opensource/moderation-support](https://aka.ms/opensource/moderation-support)
