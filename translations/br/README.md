...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2026-01-16T08:48:13+00:00",
...
![Construindo Agentes de IA do Zero à Produção](../../../../translated_images/br/repo-thumbnail.083b24afed61b6dd.webp)
...
Este curso tem aulas que cobrem os fundamentos de construção e implantação de Agentes de IA.

Cada aula se baseia na anterior, então recomendamos começar do início e avançar até o fim.

Se quiser explorar mais sobre temas de Agentes de IA, você pode conferir o [Curso AI Agents Para Iniciantes](https://aka.ms/ai-agents-beginners).

### Conheça Outros Estudantes, Tire Suas Dúvidas

Se você ficar travado ou tiver dúvidas sobre como construir Agentes de IA, entre no nosso Canal dedicado no Discord do [Microsoft Foundry Discord](https://discord.gg/Kuaw3ktsu6).

### O Que Você Precisa

Cada lição tem seu próprio código de exemplo que você pode executar localmente. Você pode [forkar este repositório](https://github.com/microsoft/Building-AI-Agents-From-Zero-To-Production/fork) para criar sua própria cópia.
...
| **Lição**         | **Descrição**                                                                                  |
|--------------------|--------------------------------------------------------------------------------------------------|
| [Design do Agente](./lesson-1-agent-design/README.md)       | Uma introdução ao nosso caso de uso do Agente “Onboarding de Desenvolvedor” e como projetar agentes eficazes  |
| [Desenvolvimento do Agente](./lesson-2-agent-development/README.md)  | Usando o Microsoft Agent Framework (MAF), crie 3 agentes para ajudar novos desenvolvedores no processo de onboarding.       |
| [Avaliações de Agente](./lesson-3-agent-evals/README.md)  | Usando o Microsoft Foundry, descubra quão bem nossos Agentes de IA estão performando e como melhorá-los. |
| [Implantação de Agente](./lesson-4-agent-deployment/README.md)   | Usando Agentes Hospedados e OpenAI Chatkit, veja como implantar um Agente de IA em produção.       |
...
Este projeto aceita contribuições e sugestões. A maioria das contribuições exige que você concorde com um Acordo de Licença de Contribuidor (CLA) declarando que você tem o direito de, e de fato concede, os direitos para usarmos sua contribuição. Para detalhes, visite <https://cla.opensource.microsoft.com>.
...
Para mais informações, consulte o [FAQ do Código de Conduta](https://opensource.microsoft.com/codeofconduct/faq/) ou entre em contato com [opencode@microsoft.com](mailto:opencode@microsoft.com) para quaisquer dúvidas ou comentários adicionais.
...
Se você ficar preso ou tiver qualquer dúvida sobre como construir aplicativos de IA, junte-se a:
