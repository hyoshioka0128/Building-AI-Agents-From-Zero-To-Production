...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-24T23:19:03+00:00",
...
## Un corso che ti insegna i fondamenti del ciclo di vita dello sviluppo di agenti AI

[![Licenza GitHub](https://img.shields.io/github/license/microsoft/Building-AI-Agents-From-Zero-To-Production.svg)](https://github.com/microsoft/Building-AI-Agents-From-Zero-To-Production/blob/master/LICENSE?WT.mc_id=academic-105485-koreyst)
[![Contributori GitHub](https://img.shields.io/github/contributors/microsoft/Building-AI-Agents-From-Zero-To-Production.svg)](https://GitHub.com/microsoft/Building-AI-Agents-From-Zero-To-Production/graphs/contributors/?WT.mc_id=academic-105485-koreyst)
[![Issue GitHub](https://img.shields.io/github/issues/microsoft/Building-AI-Agents-From-Zero-To-Production.svg)](https://GitHub.com/microsoft/Building-AI-Agents-From-Zero-To-Production/issues/?WT.mc_id=academic-105485-koreyst)
[![Pull request GitHub](https://img.shields.io/github/issues-pr/microsoft/Building-AI-Agents-From-Zero-To-Production.svg)](https://GitHub.com/microsoft/Building-AI-Agents-From-Zero-To-Production/pulls/?WT.mc_id=academic-105485-koreyst)
...
[![Discord di Microsoft Foundry](https://dcbadge.limes.pink/api/server/nTYy5BXMWG)](https://discord.gg/Kuaw3ktsu6)

## 🌱 Per iniziare

Questo corso include lezioni che coprono i fondamenti della creazione e della distribuzione di agenti AI.

Ogni lezione si basa sulla precedente, quindi consigliamo di iniziare dall'inizio e procedere fino alla fine.

Se vuoi esplorare ulteriormente argomenti sugli agenti AI, puoi consultare il [Corso AI Agents For Beginenrs](https://aka.ms/ai-agents-beginners).

### Incontra altri studenti, ottieni risposte alle tue domande

Se resti bloccato o hai domande sulla creazione di agenti AI, unisciti al nostro canale Discord dedicato nel [Discord di Microsoft Foundry](https://discord.gg/Kuaw3ktsu6).

### Cosa ti serve

Ogni lezione ha un proprio esempio di codice che puoi eseguire localmente. Puoi [fare il fork di questo repository](https://github.com/microsoft/Building-AI-Agents-From-Zero-To-Production/fork) per creare una tua copia.

Questo corso utilizza attualmente i seguenti:
...
Altre opzioni relative all'hosting dei modelli e ai servizi arriveranno presto. 

## 🗃️ Lezioni

| **Lezione**         | **Descrizione**                                                                                  |
|--------------------|--------------------------------------------------------------------------------------------------|
| [Progettazione dell'agente](./lesson-1-agent-design/README.md)       | Introduzione al nostro caso d'uso "Developer Onboarding" per agenti e a come progettare agenti efficaci  |
| [Sviluppo dell'agente](./lesson-2-agent-development/README.md)  | Usando Microsoft Agent Framework (MAF), crea 3 agenti per aiutare i nuovi sviluppatori nell'onboarding.       |
| [Valutazioni degli agenti](./lesson-3-agent-evals/README.md)  | Usando Microsoft Foundry, scopri quanto bene si comportano i nostri agenti AI e come migliorarli. |
| [Distribuzione dell'agente](./lesson-4-agent-deployment/README.md)   | Usando Hosted Agents e OpenAI Chatkit, scopri come distribuire un agente AI in produzione.       |
...
Questo progetto accoglie contributi e suggerimenti. La maggior parte dei contributi richiede che tu accetti un Contributor License Agreement (CLA) che dichiari di avere il diritto e di concederci effettivamente i diritti di utilizzare il tuo contributo. Per i dettagli, visita <https://cla.opensource.microsoft.com>.

Quando invii una pull request, un bot CLA determinerà automaticamente se devi fornire una CLA e decorerà la PR di conseguenza (ad es., controllo di stato, commento). Segui semplicemente le istruzioni fornite dal bot. Dovrai farlo solo una volta per tutti i repository che usano la nostra CLA.
...
Questo progetto può contenere marchi o loghi di progetti, prodotti o servizi. L'uso autorizzato di marchi o loghi Microsoft è soggetto e deve seguire le [Linee guida sui marchi e sul branding di Microsoft](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general). L'uso di marchi o loghi Microsoft in versioni modificate di questo progetto non deve creare confusione né implicare sponsorizzazione da parte di Microsoft. Qualsiasi uso di marchi o loghi di terzi è soggetto alle politiche di tali terze parti.
