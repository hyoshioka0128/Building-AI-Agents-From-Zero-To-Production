...
![Costruire Agenti AI da Zero alla Produzione](../../translated_images/it/repo-thumbnail.083b24afed61b6dd.webp)
...
## Un corso che insegna le basi del ciclo di vita dello sviluppo degli Agenti AI
...
Questo corso contiene lezioni che coprono le basi della costruzione e distribuzione di Agenti AI.

Ogni lezione si basa sulla precedente, quindi ti consigliamo di iniziare dall’inizio e procedere fino alla fine.

Se vuoi esplorare ulteriori argomenti sugli Agenti AI, puoi consultare il [Corso AI Agents For Beginners](https://aka.ms/ai-agents-beginners).

### Incontra altri studenti, ricevi risposte alle tue domande

Se rimani bloccato o hai domande sulla costruzione di Agenti AI, unisciti al nostro canale Discord dedicato in [Microsoft Foundry Discord](https://discord.gg/Kuaw3ktsu6).

### Cosa ti Serve

Ogni lezione ha un proprio esempio di codice che puoi eseguire localmente. Puoi [forkare questo repo](https://github.com/microsoft/Building-AI-Agents-From-Zero-To-Production/fork) per creare la tua copia.

Questo corso usa attualmente:
...
Presto saranno disponibili più opzioni per hosting di modelli e servizi.

## 🗃️ Lezioni

| **Lezione**         | **Descrizione**                                                                                  |
|--------------------|--------------------------------------------------------------------------------------------------|
| [Design dell’Agente](./lesson-1-agent-design/README.md)       | Un’introduzione al caso d’uso “Developer Onboarding” e come progettare agenti efficaci  |
| [Sviluppo dell’Agente](./lesson-2-agent-development/README.md)  | Usando Microsoft Agent Framework (MAF), crea 3 agenti per aiutare i nuovi sviluppatori ad ambientarsi.       |
| [Valutazioni degli Agenti](./lesson-3-agent-evals/README.md)  | Usando Microsoft Foundry, scopri come stanno performando i nostri Agenti AI e come migliorarli. |
| [Distribuzione degli Agenti](./lesson-4-agent-deployment/README.md)   | Usando Hosted Agents e OpenAI Chatkit, vedi come distribuire un Agente AI in produzione.       |
...
Questo progetto accoglie contributi e suggerimenti. La maggior parte dei contributi richiede di accettare 
un Accordo di Licenza del Contributore (CLA) che dichiara che hai il diritto di, e concedi effettivamente,
...
fornite dal bot. Dovrai farlo solo una volta per tutti i repository che usano la nostra CLA.
...
Questo progetto può contenere marchi o loghi di progetti, prodotti o servizi. L'uso autorizzato dei 
marchi o loghi Microsoft è soggetto e deve seguire
le [Linee guida sui marchi e sul brand Microsoft](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general).
...
Se sei bloccato o hai domande sulla creazione di applicazioni AI, unisciti a:
...
**Disclaimer**:  
Questo documento è stato tradotto utilizzando il servizio di traduzione AI [Co-op Translator](https://github.com/Azure/co-op-translator). Pur impegnandoci per l'accuratezza, si prega di notare che le traduzioni automatiche possono contenere errori o imprecisioni. Il documento originale nella sua lingua nativa deve essere considerato la fonte autorevole. Per informazioni critiche, si raccomanda la traduzione professionale umana. Non ci assumiamo responsabilità per eventuali malintesi o interpretazioni errate derivanti dall'uso di questa traduzione.
