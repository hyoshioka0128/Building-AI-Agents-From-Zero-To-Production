...
![Building AI Agents from Zero to Production](../../translated_images/it/repo-thumbnail.083b24afed61b6dd.webp)
...
## Un corso che ti insegna le basi del Ciclo di Sviluppo degli Agenti AI
...
Questo corso contiene lezioni che coprono le basi della costruzione e del deploy di Agenti AI.

Ogni lezione si basa sulla precedente, quindi consigliamo di iniziare dall’inizio e procedere fino alla fine.

Se vuoi esplorare ulteriormente argomenti sugli Agenti AI, puoi dare un’occhiata al [Corso AI Agents For Beginners](https://aka.ms/ai-agents-beginners).

### Incontra Altri Studenti, Ottieni le Tue Risposte

Se ti blocchi o hai domande sulla costruzione di Agenti AI, entra nel nostro canale Discord dedicato nel [Microsoft Foundry Discord](https://discord.gg/Kuaw3ktsu6).
...
Altre opzioni per hosting di modelli e servizi in arrivo a breve.

## 🗃️ Lezioni

| **Lezione**         | **Descrizione**                                                                                  |
|--------------------|--------------------------------------------------------------------------------------------------|
| [Agent Design](./lesson-1-agent-design/README.md)       | Un’introduzione al nostro caso d’uso “Developer Onboarding” e come progettare agenti efficaci  |
| [Agent Development](./lesson-2-agent-development/README.md)  | Usando il Microsoft Agent Framework (MAF), crea 3 agenti per aiutare i nuovi sviluppatori a iniziare.       |
| [Agent Evaluations](./lesson-3-agent-evals/README.md)  | Usando Microsoft Foundry, scopri come si comportano i nostri Agenti AI e come migliorarli. |
| [Agent Deployment](./lesson-4-agent-deployment/README.md)   | Usando gli Hosted Agents e OpenAI Chatkit, scopri come distribuire un Agente AI in produzione.       |
...
Accordo di Licenza per Contributori (CLA) che dichiari che avete il diritto e effettivamente concedete
i diritti di usare il vostro contributo. Per dettagli, visitare <https://cla.opensource.microsoft.com>.

Quando inviate una pull request, un bot CLA determinerà automaticamente se è necessario fornire
una CLA e decorerà la PR di conseguenza (ad esempio, controllo stato, commento). Basta seguire le istruzioni
fornite dal bot. Dovrete farlo una sola volta per tutti i repository che usano la nostra CLA.

Questo progetto ha adottato il [Microsoft Open Source Code of Conduct](https://opensource.microsoft.com/codeofconduct/).
Per maggiori informazioni vedere le [FAQ sul Codice di Condotta](https://opensource.microsoft.com/codeofconduct/faq/) o
contattare [opencode@microsoft.com](mailto:opencode@microsoft.com) per qualsiasi altra domanda o commento.
...
è soggetto e deve seguire le [Linee Guida sui Marchi & Brand di Microsoft](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general).
...
Se siete bloccati o avete domande sulla creazione di applicazioni AI, unitevi a:

[![Microsoft Foundry Discord](https://dcbadge.limes.pink/api/server/nTYy5BXMWG)](https://discord.gg/Kuaw3ktsu6)

Se avete feedback sul prodotto o errori durante lo sviluppo visitate:
