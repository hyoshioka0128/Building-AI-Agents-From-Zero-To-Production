# Lesson 4: 使用 Azure AI Foundry 託管代理與 ChatKit 部署代理
...
1. 位於北中美洲地區的 **Azure AI Foundry 專案**
...
cp .env.example .env
# 使用您的 Azure AI Foundry 專案詳細資訊編輯 .env
```
...
在瀏覽器中開啟 `http://localhost:3000` 並嘗試以下查詢：
...
| **學習代理** | 建立學習路徑與建議 | HostedMCPTool（Microsoft Learn） |
| **程式代理** | 產生程式範例與指導 | 無 |
