...
![從零到生產環境構建 AI 代理人](../../translated_images/zh-TW/repo-thumbnail.083b24afed61b6dd.webp)
...
> 本儲存庫包含超過 50 種語言的翻譯，這會顯著增加下載大小。要下載不含翻譯的版本，請使用稀疏簽出：
> ```bash
> git clone --filter=blob:none --sparse https://github.com/microsoft/Building-AI-Agents-From-Zero-To-Production.git
> cd Building-AI-Agents-From-Zero-To-Production
> git sparse-checkout set --no-cone '/*' '!translations' '!translated_images'
> ```
> 這樣您便能以更快的速度下載，並擁有完成課程所需的所有內容。
<!-- CO-OP TRANSLATOR LANGUAGES TABLE END -->

## 一門教你 AI 代理人開發生命週期基礎的課程
...
本課程涵蓋建構與部署 AI 代理人的基礎知識。

每節課都是基於前一節課進行，建議您從頭開始，逐步學習至最後。

如果您想了解更多 AI 代理人相關主題，可以查看 [AI 代理人初學者課程](https://aka.ms/ai-agents-beginners)。

### 認識其他學習者、解答您的問題

如果您遇到困難或有任何關於構建 AI 代理人的問題，歡迎加入我們在 [Microsoft Foundry Discord](https://discord.gg/Kuaw3ktsu6) 的專屬 Discord 頻道。

### 您需要準備的東西

每個課程都有專屬的程式碼範例，您可以在本機執行。您可以 [fork 本儲存庫](https://github.com/microsoft/Building-AI-Agents-From-Zero-To-Production/fork) 以建立屬於自己的副本。
...
| **課程**           | **說明**                                                                                            |
|--------------------|---------------------------------------------------------------------------------------------------|
| [代理人設計](./lesson-1-agent-design/README.md)           | 介紹我們的「開發者入門」代理人使用案例以及如何設計有效的代理人                                              |
| [代理人開發](./lesson-2-agent-development/README.md)       | 使用 Microsoft Agent Framework (MAF)，建立 3 個幫助新開發者入門的代理人                                      |
| [代理人評估](./lesson-3-agent-evals/README.md)             | 使用 Microsoft Foundry，了解我們的 AI 代理人表現如何及如何改進                                              |
| [代理人部署](./lesson-4-agent-deployment/README.md)         | 使用 Hosted Agents 和 OpenAI Chatkit，了解如何將 AI 代理人部署到生產環境                                      |
...
[![初學者資訊安全](https://img.shields.io/badge/Cybersecurity%20for%20Beginners-F97316?style=for-the-badge&labelColor=E5E7EB&color=F97316)](https://github.com/microsoft/Security-101?WT.mc_id=academic-96948-sayoung)
...
[![初學者擴增實境與虛擬實境開發](https://img.shields.io/badge/XR%20Development%20for%20Beginners-38BDF8?style=for-the-badge&labelColor=E5E7EB&color=38BDF8)](https://github.com/microsoft/xr-development-for-beginners?WT.mc_id=academic-105485-koreyst)
...
這個專案歡迎貢獻與建議。大部分貢獻需要您同意一份
貢獻者授權協議 (CLA)，聲明您有權利並實際授權我們使用您的貢獻。詳情請參閱 <https://cla.opensource.microsoft.com>。

當您提交拉取請求時，CLA 機器人會自動判斷您是否需要提供
CLA 並適當地標記該 PR（例如狀態檢查、評論）。只需按照機器人的說明操作即可。
您在所有使用我們 CLA 的倉庫中，只需執行一次此操作。

此專案已採納 [Microsoft 開源行為準則](https://opensource.microsoft.com/codeofconduct/)。
...
商標或標誌必須遵守並按照
[Microsoft 商標與品牌指導方針](https://www.microsoft.com/legal/intellectualproperty/trademarks/usage/general)。
以修改版本的本專案使用 Microsoft 商標或標誌，不得造成混淆或暗示 Microsoft 贊助。
任何使用第三方商標或標誌均須遵循該第三方的相關政策。

## 尋求協助

如果您遇到困難或有任何關於建構 AI 應用程式的問題，歡迎加入：
...
**免責聲明**：  
本文件係使用 AI 翻譯服務 [Co-op Translator](https://github.com/Azure/co-op-translator) 進行翻譯。雖然我們致力於確保翻譯的準確性，但請注意自動翻譯可能包含錯誤或不準確之處。原始文件的母語版本應視為權威來源。對於重要資訊，建議採用專業人力翻譯。如因使用本翻譯產生任何誤解或誤譯，我們概不負責。
