...
## Et kurs som lærer deg grunnleggende om AI-agenters utviklingslivssyklus
...
Hvis du ønsker å utforske mer om AI-agentemner, kan du sjekke ut [AI Agents For Beginners-kurset](https://aka.ms/ai-agents-beginners).
...
Dette kurset bruker for tiden følgende:
...
| **Leksjon**          | **Beskrivelse**                                                                                   |
|----------------------|--------------------------------------------------------------------------------------------------|
| [Agent Design](./lesson-1-agent-design/README.md)           | En introduksjon til vår «Utvikler Onboarding»-agentbrukstilfelle og hvordan designe effektive agenter  |
| [Agent Development](./lesson-2-agent-development/README.md) | Bruk Microsoft Agent Framework (MAF) til å lage 3 agenter som hjelper nye utviklere med onboarding.     |
| [Agent Evaluations](./lesson-3-agent-evals/README.md)       | Bruk Microsoft Foundry, finn ut hvor bra AI-agentene våre presterer og hvordan forbedre dem.           |
| [Agent Deployment](./lesson-4-agent-deployment/README.md)   | Bruk Hosted Agents og OpenAI Chatkit, se hvordan man distribuerer en AI-agent i produksjon.            |
...
en CLA og dekorere PR-en på riktig måte (f.eks. statuskontroll, kommentar). Bare følg instruksjonene
...
kontakt [opencode@microsoft.com](mailto:opencode@microsoft.com) med eventuelle ekstra spørsmål eller kommentarer.
...
Bruk av Microsoft-varemerker eller logoer i modifiserte versjoner av dette prosjektet skal ikke skape forvirring eller antyde Microsoft-sponsorering.
