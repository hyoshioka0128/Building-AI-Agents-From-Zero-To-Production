...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-12-24T23:31:51+00:00",
...
![Bygge AI-agenter fra null til produksjon](../../translated_images/no/repo-thumbnail.083b24afed61b6dd27a7fc53798bebe9edf688a41031163a1fca9f61c64d63ec.png)
...
## Et kurs som lærer deg grunnleggende om livssyklusen for utvikling av AI-agenter
...
Dette kurset har leksjoner som dekker grunnprinsippene for å bygge og distribuere AI-agenter.

Hver leksjon bygger på den forrige, så vi anbefaler å starte fra begynnelsen og jobbe deg gjennom til slutten.

Hvis du vil utforske mer om AI-agentemner, kan du sjekke ut [AI Agents For Beginenrs Course](https://aka.ms/ai-agents-beginners).
...
Hver leksjon har sitt eget kodesample som du kan kjøre lokalt. Du kan [forke dette repoet](https://github.com/microsoft/Building-AI-Agents-From-Zero-To-Production/fork) for å lage din egen kopi.
...
| **Leksjon**         | **Beskrivelse**                                                                                  |
|--------------------|--------------------------------------------------------------------------------------------------|
| [Agent Design](./lesson-1-agent-design/README.md)       | En introduksjon til vårt "Developer Onboarding" agent-brukstilfelle og hvordan designe effektive agenter  |
| [Agent Development](./lesson-2-agent-development/README.md)  | Ved å bruke Microsoft Agent Framework (MAF), opprett 3 agenter for å hjelpe nye utviklere med onboarding.       |
...
| [Agent Deployment](./lesson-4-agent-deployment/README.md)   | Ved hjelp av Hosted Agents og OpenAI Chatkit, se hvordan du distribuerer en AI-agent i produksjon.       |
...
Dette prosjektet tar imot bidrag og forslag. De fleste bidrag krever at du samtykker i en Contributor License Agreement (CLA) som bekrefter at du har rett til, og faktisk gir oss, rettighetene til å bruke bidraget ditt. For detaljer, se <https://cla.opensource.microsoft.com>.

Når du sender inn en pull request, vil en CLA-bot automatisk avgjøre om du må levere en CLA og merke PR-en hensiktsmessig (f.eks. status-sjekk, kommentar). Følg ganske enkelt instruksjonene fra boten. Du trenger bare å gjøre dette én gang for alle repositorier som bruker vår CLA.

Dette prosjektet har tatt i bruk [Microsoft Open Source Code of Conduct](https://opensource.microsoft.com/codeofconduct/).
For mer informasjon, se [Code of Conduct FAQ](https://opensource.microsoft.com/codeofconduct/faq/) eller kontakt [opencode@microsoft.com](mailto:opencode@microsoft.com) hvis du har ytterligere spørsmål eller kommentarer.
...
Bruk av Microsoft-varemerker eller -logoer i modifiserte versjoner av dette prosjektet må ikke skape forvirring eller antyde at Microsoft sponser det.
...
Hvis du har produkttilbakemeldinger eller finner feil under utvikling, besøk:
